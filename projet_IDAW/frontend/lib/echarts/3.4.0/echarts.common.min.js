!function (t, e) {
    ...
    return function (t) {
        ...
        t.exports = i(2), i(100), i(94), i(104), i(178), i(191), i(215), i(192), i(31), i(206), i(199), i(198), i(197), i(181), i(207), i(222)
    }, function (t, e) {
        function i(t) {
            ...
            } else if (D[n]) e = t.constructor.from(t); else if (!P[n] && !T(t)) {
                e = {};
        ...
        function f(t, e, i) {
            if (t && e) if (t.forEach && t.forEach === E) t.forEach(e, i); else if (t.length === +t.length) for (var n = 0, r = t.length; n < r; n++) e.call(i, t[n], n, t); else for (var o in t) t.hasOwnProperty(o) && e.call(i, t[o], o, t)
        }
        ...
        function m(t, e, i) {
            if (t && e) {
                if (t.filter && t.filter === N) return t.filter(e, i);
        ...
        var L, P = {
            ...
            }, O = Object.prototype.toString, z = Array.prototype, E = z.forEach, N = z.filter, R = z.slice, B = z.map,
            V = z.reduce, F = {
                inherits: u,
                mixin: c,
                clone: i,
        ...
        function o(t, e, i) {
            ...
            this._throttledZrFlush = O.throttle(E.bind(o.flush, o), 17), this._theme = E.clone(e), this._chartsViews = [], this._chartsMap = {}, this._componentsViews = [], this._componentsMap = {}, this._api = new S(this), this._coordSysMgr = new T, R.call(this), this._messageCenter = new r, this._initEvents(), this.resize = E.bind(this.resize, this), this._pendingActions = [], B(ot, n), B(nt, n), o.animation.on("frame", this._onframe, this)
        }
        ...
        function s(t, e, i, n, r) {
            ...
            r && (s.subType = r), o && o.eachComponent(s, function (r, a) {
                var s = t["series" === n ? "_chartsMap" : "_componentsMap"][r.__viewId];
                s && s.__alive && s[e](r, o, t._api, i)
            }, t)
        }

        function l(t, e) {
            var i = t.type, n = et[i], r = n.actionInfo, o = (r.update || "update").split(":"), a = o.pop();
            o = o[0] && F(o[0]), this[X] = !0;
            var l = [t], h = !1;
            t.batch && (h = !0, l = E.map(t.batch, function (e) {
                return e = E.defaults(E.extend({}, e), t), e.batch = null, e
            }));
            for (var u, c = [], d = "highlight" === i || "downplay" === i, f = 0; f < l.length; f++) {
                var p = l[f];
                u = n.action(p, this._model), u = u || E.extend({}, p), u.type = r.event || u.type, c.push(u), d ? s(this, a, p, "series") : o && s(this, a, p, o.main, o.sub)
            }
            "none" === a || d || o || (this[$] ? (J.prepareAndUpdate.call(this, t), this[$] = !1) : J[a].call(this, t)), u = h ? {
                type: r.event || i,
                batch: c
            } : c[0], this[X] = !1, !e && this._messageCenter.trigger(u.type, u)
        }
        ...
        function d(t, e) {
            ...
            e[i ? "eachComponent" : "eachSeries"](function (t, a) {
                ...
                if (!l) {
                    var h = F(a.type), u = i ? k.getClass(h.main, h.sub) : L.getClass(h.sub);
                    if (!u) return;
        ...
        function v(t, e) {
            var i = this._api;
            V(this._componentsViews, function (n) {
                var r = n.__model;
                n.render(r, t, i, e), _(r, n)
            }, this), V(this._chartsViews, function (t) {
                t.__alive = !1
            }, this), t.eachSeries(function (n, r) {
                var o = this._chartsMap[n.__viewId];
                o.__alive = !0, o.render(n, t, i, e), o.group.silent = !!n.get("silent"), _(n, o), x(n, o)
            }, this), y(this._zr, t), V(this._chartsViews, function (e) {
        ...
        function x(t, e) {
            ...
            var n = +t.get("progressive"), r = i > t.get("progressiveThreshold") && n && !w.node;
	 ...
	 */
        var w = i(10), M = i(125), S = i(93), T = i(23), A = i(126), I = i(13), C = i(16), k = i(59), L = i(28),
            P = i(3), D = i(6), O = i(47), z = i(78), E = i(1), N = i(19), R = i(21), B = i(46), V = E.each,
            F = I.parseClassType, G = 1e3, H = 5e3, W = 1e3, Z = 2e3, q = 3e3, j = 4e3, U = 5e3,
            X = "__flagInMainProcess", Y = "__hasGradientOrPatternBg", $ = "__optionUpdated", Q = /^[a-zA-Z0-9_]+$/;
        r.prototype.on = n("on"), r.prototype.off = n("off"), r.prototype.one = n("one"), E.mixin(r, R);
        var K = o.prototype;
        K._onframe = function () {
            if (this[$]) {
                var t = this[$].silent;
                this[X] = !0, J.prepareAndUpdate.call(this), this[X] = !1, this[$] = !1, h.call(this, t), u.call(this, t)
            }
        }, K.getDom = function () {
            return this._dom
        }, K.getZr = function () {
            ...
            if (E.isObject(e) && (i = e.lazyUpdate, n = e.silent, e = e.notMerge), this[X] = !0, !this._model || e) {
                var r = new A(this._api), o = this._theme, a = this._model = new M(null, null, o, r);
                a.init(null, null, o, r)
            }
            this.__lastOnlyGraphic = !(!t || !t.graphic), E.each(t, function (t, e) {
                "graphic" !== e && (this.__lastOnlyGraphic = !1)
            }, this), this._model.setOption(t, rt), i ? (this[$] = {silent: n}, this[X] = !1) : (J.prepareAndUpdate.call(this), this._zr.flush(), this[$] = !1, this[X] = !1, h.call(this, n), u.call(this, n))
        }, K.setTheme = function () {
            ...
            if (w.canvasSupported) {
                ...
                if (ht[e]) {
                    ...
                    E.each(lt, function (r, u) {
                        if (r.group === e) {
                            var c = r.getRenderedCanvas(E.clone(t)), d = r.getDom().getBoundingClientRect();
                    ...
                    var c = s - o, d = l - a, f = E.createCanvas();
                    f.width = c, f.height = d;
                    var p = z.init(f);
                    return V(h, function (t) {
                        var e = new P.Image({style: {x: t.left * u - o, y: t.top * u - a, image: t.dom}});
                        p.add(e)
            ...
            var i, n = this._model;
            return t = D.parseFinder(n, t), E.each(t, function (t, n) {
            ...
            var i = this._model;
            t = D.parseFinder(i, t, {defaultMainType: "series"});
            ...
            update: function (t) {
                ...
                if (e) {
                    ...
                    if (a.isSingleCanvas && a.isSingleCanvas()) r.configLayer(0, {clearColor: o}); else {
                        if (!w.canvasSupported) {
                            var s = N.parse(o);
                            o = N.stringify(s, "rgb"), 0 === s[3] && (o = "transparent")
                        }
                        o.colorStops || o.image ? (r.configLayer(0, {clearColor: o}), this[Y] = !0, this._dom.style.background = "transparent") : (this[Y] && r.configLayer(0, {clearColor: null}), this[Y] = !1, this._dom.style.background = o)
                    }
                }
                ...
                var e = this._model;
                d.call(this, "component", e), d.call(this, "chart", e), this.__lastOnlyGraphic ? (V(this._componentsViews, function (i) {
                    var n = i.__model;
        ...
        K.resize = function (t) {
            ...
            if (E.isObject(e) || (e = {silent: !!e}), et[t.type]) {
                ...
                l.call(this, t, e.silent), e.flush ? this._zr.flush(!0) : e.flush !== !1 && w.browser.weChat && this._throttledZrFlush(), h.call(this, e.silent), u.call(this, e.silent)
            }
        ...
        K._initEvents = function () {
            V(tt, function (t) {
                this._zr.on(t, function (e) {
                    ...
                    } else r && r.eventData && (i = E.extend({}, r.eventData));
                    i && (i.event = e, i.type = t, this.trigger(t, i))
                }, this)
            }, this), V(it, function (t, e) {
            ...
            if (!this._disposed) {
                ...
                V(this._componentsViews, function (i) {
                    i.dispose(e, t)
                }), V(this._chartsViews, function (i) {
                    i.dispose(e, t)
                }), this._zr.dispose(), delete lt[this.id]
            }
        }, E.mixin(o, R);
        var et = [], it = {}, nt = [], rt = [], ot = [], at = {}, st = {}, lt = {}, ht = {}, ut = new Date - 0,
            ct = new Date - 0, dt = "_echarts_instance_", ft = {version: "3.4.0", dependencies: {zrender: "3.3.0"}};
        ft.init = function (t, e, i) {
            var n = new o(t, e, i);
            return n.id = "ec_" + ut++, lt[n.id] = n, t.setAttribute && t.setAttribute(dt, n.id), b(n), n
            ...
            E.isDom(t) ? t = ft.getInstanceByDom(t) : "string" == typeof t && (t = lt[t]), t instanceof o && !t.isDisposed() && t.dispose()
            ...
            "function" == typeof t && (e = t, t = G), nt.push({prio: t, func: e})
            ...
            "function" == typeof t && (e = t, t = W), ot.push({prio: t, func: e, isLayout: !0})
        }, ft.registerVisual = function (t, e) {
            "function" == typeof t && (e = t, t = q), ot.push({prio: t, func: e})
            ...
            event: "downplay",
            update: "downplay"
        }, E.noop), ft.List = i(14), ft.Model = i(11), ft.graphic = i(3), ft.number = i(4), ft.format = i(8), ft.throttle = O.throttle, ft.matrix = i(20), ft.vector = i(5), ft.color = i(19), ft.util = {}, V(["map", "each", "filter", "indexOf", "inherits", "reduce", "filter", "bind", "curry", "isArray", "isString", "isObject", "isFunction", "extend", "defaults", "clone"], function (t) {
            ft.util[t] = E[t]
        }), ft.PRIORITY = {
            PROCESSOR: {FILTER: G, STATISTIC: H},
        ...
        function g(t, e, i, n, r, o) {
            ...
            if (a) {
                ...
                "function" == typeof u && (u = u(r, n.getAnimationDelayParams ? n.getAnimationDelayParams(e, r) : null)), "function" == typeof l && (l = l(r)), l > 0 ? e.animateTo(i, l, u || 0, h, o) : (e.attr(i), o && o())
            } else e.attr(i), o && o()
        }

        var m = i(1), v = i(169), y = Math.round, x = i(7), _ = i(19), b = i(20), w = i(5), M = {};
        M.Group = i(34), M.Image = i(49), M.Text = i(76), M.Circle = i(160), M.Sector = i(166), M.Ring = i(165), M.Polygon = i(162), M.Polyline = i(163), M.Rect = i(164), M.Line = i(161), M.BezierCurve = i(159), M.Arc = i(158), M.CompoundPath = i(153), M.LinearGradient = i(91), M.RadialGradient = i(154), M.BoundingRect = i(9), M.extendShape = function (t) {
            return x.extend(t)
            ...
            var n = e.getShallow("position") || "inside", r = e.getShallow("offset"),
                o = n.indexOf("inside") >= 0 ? "white" : i, a = e.getModel("textStyle");
            m.extend(t, {
        ...
        n.linearMap = function (t, e, i, n) {
            ...
            var i = Math.log, n = Math.LN10, r = Math.floor(i(t[1] - t[0]) / n),
                o = Math.round(i(Math.abs(e[1] - e[0])) / n), a = Math.min(Math.max(-r + o, 0), 20);
        ...
        var r = i(8), o = i(4), a = i(11), s = i(1), l = s.each, h = s.isObject, u = {};
        u.normalizeToArray = function (t) {
        ...
        }, u.LABEL_OPTIONS = ["position", "offset", "show", "textStyle", "distance", "formatter"], u.getDataItemValue = function (t) {
            ...
            l(t, function (t, i) {
                ...
                if (h(r)) {
                    if (o.name = null != r.name ? r.name + "" : n ? n.name : "\0-", n) o.id = n.id; else if (null != r.id) o.id = r.id + ""; else {
                        var a = 0;
                        do o.id = "\0" + o.name + "\0" + a++; while (e[o.id])
                    }
                    e[o.id] = t
                }
            })
            ...
            function i(t, e, i) {
                for (var n = 0, r = t.length; n < r; n++) for (var o = t[n].seriesId, a = u.normalizeToArray(t[n].dataIndex), s = i && i[o], l = 0, h = a.length; l < h; l++) {
                    var c = a[l];
        ...
        var r = i(36), o = i(1), a = i(29), s = i(149), l = i(65), h = l.prototype.getCanvasPattern, u = Math.abs;
        n.prototype = {
            constructor: n, type: "path", __dirtyPath: !0, strokeContainThreshold: 5, brush: function (t, e) {
                var i = this.style, n = this.path, r = i.hasStroke(), o = i.hasFill(), a = i.fill, s = i.stroke,
                    l = o && !!a.colorStops, u = r && !!s.colorStops, c = o && !!a.image, d = r && !!s.image;
        ...
        }, l = ["a", "b", "c", "d", "e", "f", "g"], h = function (t, e) {
            return "{" + t + (null == e ? "" : e) + "}"
        };
        a.formatTpl = function (t, e, i) {
            ...
            for (var d = 0; d < r; d++) for (var f = 0; f < o.length; f++) {
                var c = e[d][o[f]];
                t = t.replace(h(l[f], d), i ? s(c) : c)
            }
            return t
        };
        var u = function (t) {
        ...
        var r = i(5), o = i(20), a = r.applyTransform, s = Math.min, l = Math.max;
        n.prototype = {
            constructor: n, union: function (t) {
                ...
                return function (r) {
                    if (r) {
                        ...
                        var o = l(t[0], e[0], i[0], n[0]), h = l(t[1], e[1], i[1], n[1]);
                ...
                var e = this, i = e.x, r = e.x + e.width, o = e.y, a = e.y + e.height, s = t.x, l = t.x + t.width,
        ...
        n.prototype = {
            constructor: n, init: null, mergeOption: function (t) {
                ...
                var i = this.option, n = null == i ? i : i[t], r = !e && o(this, t);
        ...
        var h = a.mixin;
        h(n, i(131)), h(n, i(128)), h(n, i(132)), h(n, i(130)), t.exports = n
    }, function (t, e, i) {
        "use strict";
        ...
        var r = i(1), o = i(9), a = i(4), s = i(8), l = a.parsePercent, h = r.each, u = {},
        ...
        u.box = n, u.vbox = r.curry(n, "vertical"), u.hbox = r.curry(n, "horizontal"), u.getAvailableSize = function (t, e, i) {
            ...
            var n = e.width, r = e.height, a = l(t.left, n), h = l(t.top, r), u = l(t.right, n), c = l(t.bottom, r),
                d = l(t.width, n), f = l(t.height, r), p = i[2] + i[0], g = i[1] + i[3], m = t.aspect;
            ...
            var s = !a || !a.hv || a.hv[0], l = !a || !a.hv || a.hv[1], h = a && a.boundingMode || "all";
            if (s || l) {
                var c;
                if ("raw" === h) c = "group" === t.type ? new o(0, 0, +e.width || 0, +e.height || 0) : t.getBoundingRect(); else if (c = t.getBoundingRect(), t.needLocalTransform()) {
                ...
                t.attr("position", "raw" === h ? [p, g] : [f[0] + p, f[1] + g])
            }
            ...
            function n(n) {
                ...
                if (h(n, function (e) {
                    ...
                    o(e, t) && (r[t] = l[t] = e[t]), a(r, t) && s++, a(l, t) && u++
                }), u !== c && s) {
                    if (s >= c) return r;
        ...
        var r = i(11), o = i(1), a = Array.prototype.push, s = i(44), l = i(15), h = i(12), u = r.extend({
            type: "component",
            id: "",
            name: "",
            mainType: "",
        ...
        l.enableClassManagement(u, {registerWhenExtend: !0}), s.enableSubTypeDefaulter(u), s.enableTopologicalTravel(u, n), o.mixin(u, i(129)), t.exports = u
    }, function (t, e, i) {
        (function (e) {
            function n(t) {
            ...
            var o = "undefined", a = "undefined" == typeof window ? e : window,
                ...
                h = {"float": s, "int": l, ordinal: Array, number: Array, time: Array}, u = i(11), c = i(43), d = i(1),
            ...
            y.type = "list", y.hasItemOption = !0, y.getDimension = function (t) {
                ...
                var e, i = this._idList, n = t && t._idList, r = "e\0\0";
        ...
        var a = i(1), s = {}, l = ".", h = "___EC__COMPONENT__CONTAINER___", u = "\0ec_\0";
        ...
        s.enableClassExtend = function (t, e) {
            t.$constructor = t, t.extend = function (t) {
                ...
                return a.extend(i.prototype, t), i.extend = this.extend, i.superCall = r, i.superApply = o, a.inherits(i, this), i.superClass = e, i
            }
        ...
        "use strict";
        var n = i(1), r = i(8), o = i(15), a = i(6), s = i(13), l = i(57), h = i(10), u = i(12), c = o.set, d = o.get,
            f = r.encodeHTML, p = r.addCommas, g = s.extend({
                ...
                mergeDefaultAndTheme: function (t, e) {
                    var i = this.layoutMode, r = i ? u.getLayoutParams(t) : {};
                    n.merge(t, e.getTheme().get(this.subType)), n.merge(t, this.getDefaultOption()), a.defaultEmphasis(t.label, a.LABEL_OPTIONS), this.fillDataTextStyle(t.data), i && u.mergeLayoutParam(t, r, i)
                },
                mergeOption: function (t, e) {
                ...
                formatTooltip: function (t, e, i) {
                    function o(t) {
                        ...
                        return n.each(t, function (t, n) {
                            ...
                            o = "ordinal" === l ? t + "" : "time" === l ? e ? "" : r.formatTime("yyyy/MM/dd hh:mm:ss", t) : p(t), o && i.push(o)
                        }), i.join(", ")
                    }

                    var a = d(this, "data"), s = this.getRawValue(t), l = f(n.isArray(s) ? o(s) : p(s)), h = a.getName(t),
                        u = a.getItemVisual(t, "color");
                    n.isObject(u) && u.colorStops && (u = (u.colorStops[0] || {}).color), u = u || "transparent";
                    var c = '<span style="display:inline-block;margin-right:5px;border-radius:10px;width:9px;height:9px;background-color:' + f(u) + '"></span>',
                        g = this.name;
                    return "\0-" === g && (g = ""), e ? c + f(this.name) + " : " + l : (g && f(g) + "<br />") + c + (h ? f(h) + " : " + l : l)
                },
                isAnimationEnabled: function () {
                    if (h.node) return !1;
        ...
        var l = {}, h = 0, u = 5e3, c = i(1), d = i(9), f = c.retrieve, p = {
            getWidth: n,
            getBoundingRect: r,
        ...
        function s(t, e, i, r, o, a) {
            var s = r + 3 * (e - i) - t, l = 3 * (i - 2 * e + t), h = 3 * (e - t), u = t - o, c = l * l - 3 * s * h,
                d = l * h - 9 * s * u, f = h * h - 3 * l * u, p = 0;
            if (n(c) && n(d)) if (n(l)) a[0] = 0; else {
                ...
                if (n(m)) {
                    ...
                    var A = (2 * c * l - 3 * s * d) / (2 * b(c * c * c)), I = Math.acos(A) / 3, C = b(c),
                        k = Math.cos(I), g = (-l - 2 * C * k) / (3 * s), y = (-l + C * (k + S * Math.sin(I))) / (3 * s),
                        L = (-l + C * (k - S * Math.sin(I))) / (3 * s);
                    g >= 0 && g <= 1 && (a[p++] = g), y >= 0 && y <= 1 && (a[p++] = y), L >= 0 && L <= 1 && (a[p++] = L)
                }
            }
            return p
        }
        ...
        function h(t, e, i, n, r, o) {
            var a = (e - t) * r + t, s = (i - e) * r + e, l = (n - i) * r + i, h = (s - a) * r + a, u = (l - s) * r + s,
                c = (u - h) * r + h;
        ...
        var v = i(5), y = v.create, x = v.distSquare, _ = Math.pow, b = Math.sqrt, w = 1e-8, M = 1e-4, S = b(3),
            T = 1 / 3, A = y(), I = y(), C = y();
        t.exports = {
            cubicAt: o,
            cubicDerivativeAt: a,
        ...
        function g(t, e, n) {
            if (e && e.length && t >= 0 && t <= 1) {
                var o = t * (e.length - 1), a = Math.floor(o), s = Math.ceil(o), u = h(e[a]), c = h(e[s]), d = o - a,
                    f = y([i(l(u[0], c[0], d)), i(l(u[1], c[1], d)), i(l(u[2], c[2], d)), r(l(u[3], c[3], d))], "rgba");
        ...
        var n = i(137), r = i(38);
        i(138), i(136);
        var o = i(32), a = i(4), s = i(1), l = i(17), h = {};
        h.getScaleExtent = function (t, e) {
            var i, n, r, o = t.scale, l = o.type, h = e.getMin(), u = e.getMax(), c = null != h, d = null != u,
                f = o.getExtent();
            return "ordinal" === l ? i = (e.get("data") || []).length : (n = e.get("boundaryGap"), s.isArray(n) || (n = [n || 0, n || 0]), n[0] = a.parsePercent(n[0], 1), n[1] = a.parsePercent(n[1], 1), r = f[1] - f[0]), null == h && (h = "ordinal" === l ? i ? 0 : NaN : f[0] - n[0] * r), null == u && (u = "ordinal" === l ? i ? i - 1 : NaN : f[1] + n[1] * r), "dataMin" === h && (h = f[0]), "dataMax" === u && (u = f[1]), (null == h || !isFinite(h)) && (h = NaN), (null == u || !isFinite(u)) && (u = NaN), t.setBlank(s.eqNaN(h) || s.eqNaN(u)), e.getNeedCrossZero() && (h > 0 && u > 0 && !c && (h = 0), h < 0 && u < 0 && !d && (u = 0)), [h, u]
        }, h.niceScaleExtent = function (t, e) {
            var i = t.scale, n = h.getScaleExtent(t, e), r = null != e.getMin(), o = null != e.getMax(),
                a = e.get("splitNumber");
        ...
        "use strict";
        var n = i(3), r = i(9), o = n.extendShape({
            type: "triangle",
            ...
            type: "pin", shape: {x: 0, y: 0, width: 0, height: 0}, buildPath: function (t, e) {
                var i = e.x, n = e.y, r = e.width / 5 * 3, o = Math.max(r, e.height), a = r / 2, s = a * a / (o - a),
                    l = n - o + a + s, h = Math.asin(s / a), u = Math.cos(h) * a, c = Math.sin(h), d = Math.cos(h);
        ...
        function r(t, e, i, n) {
            return i = i || {}, n || !u.canvasSupported ? o(t, e, i) : u.browser.firefox && null != e.layerX && e.layerX !== e.offsetX ? (i.zrX = e.layerX, i.zrY = e.layerY) : null != e.offsetX ? (i.zrX = e.offsetX, i.zrY = e.offsetY) : o(t, e, i), i
        }
        ...
        var h = i(21), u = i(10), c = "undefined" != typeof window && !!window.addEventListener, d = c ? function (t) {
        ...
        var a = i(34), s = i(44), l = i(15), h = i(6), u = i(1);
        n.prototype = {
        ...
        "use strict";
        var n = i(18), r = i(5), o = i(75), a = i(9), s = i(33).devicePixelRatio,
            l = {M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7}, h = [], u = [], c = [], d = [], f = Math.min, p = Math.max,
        ...
        _.prototype = {
            constructor: _, _lineDash: null, _dashOffset: 0, _dashIdx: 0, _dashSum: 0, setScale: function (t, e) {
                ...
                return this.addData(l.A, t, e, i, i, n, r - n, 0, o ? 0 : 1), this._ctx && this._ctx.arc(t, e, i, n, r, o), this._xi = g(r) * i + t, this._yi = m(r) * i + t, this
                ...
                var i, n, r = this._dashSum, o = this._dashOffset, a = this._lineDash, s = this._ctx, l = this._xi,
                    h = this._yi, u = t - l, c = e - h, d = v(u * u + c * c), g = l, m = h, y = a.length;
                ...
                var s, l, h, u, c, d = this._dashSum, f = this._dashOffset, p = this._lineDash, g = this._ctx,
                    m = this._xi, y = this._yi, x = n.cubicAt, _ = 0, b = this._dashIdx, w = p.length, M = 0;
                ...
                for (var e, i, n, r, o, a, s = this.data, h = this._ux, u = this._uy, c = this._len, d = 0; d < c;) {
                    ...
                    switch (1 == d && (n = s[d], r = s[d + 1], e = n, i = r), f) {
                        ...
                        case l.Q:
                            ...
                            break;
                        case l.A:
                            var p = s[d++], v = s[d++], x = s[d++], _ = s[d++], b = s[d++], w = s[d++], M = s[d++],
                                S = s[d++], T = x > _ ? x : _, A = x > _ ? 1 : x / _, I = x > _ ? _ / x : 1,
                                C = Math.abs(x - _) > .001, k = b + w;
                            C ? (t.translate(p, v), t.rotate(M), t.scale(A, I), t.arc(0, 0, T, b, k, 1 - S), t.scale(1 / A, 1 / I), t.rotate(-M), t.translate(-p, -v)) : t.arc(p, v, T, b, k, 1 - S), 1 == d && (e = g(b) * x + p, i = m(b) * _ + v), n = g(k) * x + p, r = m(k) * _ + v;
                            break;
                        case l.R:
        ...
        i(53), i(109), o.extendComponentView({
        ...
        var n = i(1), r = i(60), o = i(9), a = function (t) {
            t = t || {}, r.call(this, t);
        ...
        function o(t, e, i) {
            ...
            var y = s ? s.categoryIndex : -1, x = new h(v, e), _ = l(s, t), b = {},
        ...
        var h = i(14), u = i(27), c = i(1), d = i(6), f = i(23), p = d.getDataItemValue, g = d.converDataValue, m = {
            cartesian2d: function (t, e, i) {
                var n = c.map(["xAxis", "yAxis"], function (t) {
                    ...
                    }), r = n[0], o = n[1], l = r.get("type"), h = o.get("type"),
                    d = [{name: "x", type: s(l), stackable: a(l)}, {name: "y", type: s(h), stackable: a(h)}],
                    f = "category" === l, p = "category" === h;
                u(d, t, ["x", "y", "z"]);
                var g = {};
                ...
                })[0], r = n.get("type"), o = "category" === r, l = [{name: "single", type: s(r), stackable: a(r)}];
                u(l, t);
                var h = {};
                return o && (h.single = n), {dimensions: l, categoryIndex: o ? 0 : -1, categoryAxesModels: h}
                ...
                var n = i.queryComponents({mainType: "polar", index: e.get("polarIndex"), id: e.get("polarId")})[0],
                    ...
                    h = r.get("type"),
                    c = [{name: "radius", type: s(l), stackable: a(l)}, {name: "angle", type: s(h), stackable: a(h)}],
                    d = "category" === h, f = "category" === l;
        ...
        var r = i(1), o = i(66), a = i(60), s = i(77);
        n.prototype = {
            constructor: n,
            type: "displayable",
            __dirty: !0,
        ...
        var n = i(4), r = i(8), o = i(32), a = Math.floor, s = Math.ceil, l = n.getPrecisionSafe, h = n.round,
            u = o.extend({
                type: "interval", _interval: 0, setExtent: function (t, e) {
                    ...
                    if (isFinite(i)) {
                        i < 0 && (i = -i, e.reverse());
                        var r = h(n.nice(i / t, !0), Math.max(l(e[0]), l(e[1])) + 2), o = l(r) + 2,
                            u = [h(s(e[0] / r) * r, o), h(a(e[1] / r) * r, o)];
        ...
        var o = i(3), a = i(50), s = n.prototype;
        ...
        var o = i(1), a = i(10), s = i(2), l = i(6), h = i(68), u = i(182), c = o.each, d = h.eachAxisDim,
            f = s.extendComponentModel({
                ...
                _giveAxisProxies: function () {
                    ...
                    this.eachTargetAxis(function (e, i, n, r) {
                        var o = this.dependentModels[e.axis][i],
                            a = o.__dzAxisProxy || (o.__dzAxisProxy = new u(e.name, i, this, r));
                        t[e.name + "_" + i] = a
                    }, this)
                },
                ...
                _autoSetAxisIndex: function () {
                    ...
                    if (t) {
                        ...
                        n[r + "Axis"].length ? (i[r + "AxisIndex"] = [0], t = !1) : c(n.singleAxis, function (n) {
        ...
        t.exports = n.extend({
            type: "dataZoom", render: function (t, e, i, n) {
                ...
                return e.eachTargetAxis(function (e, r) {
                    var o = i.getComponent(e.axis, r);
                    if (o) {
                        var a = o.getCoordSysModel();
                        a && t(a, o, n[a.mainType] || (n[a.mainType] = []), a.componentIndex)
                    }
                }, this), n
            }
        })
        ...
        var n = i(1), r = i(15), o = r.parseClassType, a = 0, s = {}, l = "_";
        s.getUID = function (t) {
        ...
        function a(t, e, i, n, r, o) {
            ...
            if (o(t, e[i + r]) > 0) {
                ...
                for (s = r + 1; l < s && o(t, e[i + r - l]) <= 0;) a = l,
                    l = (l << 1) + 1, l <= 0 && (l = s);
                l > s && (l = s);
                var h = a;
                a = r - l, l = r - h
        ...
        var r = i(36), o = i(9), a = i(1), s = i(151), l = new s(50);
        n.prototype = {
        ...
        function o(t, e, i) {
            h.Group.call(this), this.updateData(t, e, i)
        }
        ...
        var s = i(1), l = i(24), h = i(3), u = i(4), c = o.prototype;
        c._createSymbol = function (t, e, i, n) {
            this.removeAll();
            var o = e.hostModel, s = e.getItemVisual(i, "color"), u = l.createSymbol(t, -1, -1, 2, 2, s);
            u.attr({
                z2: 100,
                culling: !0,
                scale: [0, 0]
            }), u.drift = a, h.initProps(u, {scale: r(n)}, o, i), this._symbolType = t, this.add(u)
            ...
            this.silent = !1;
            var o = t.getItemVisual(e, "symbol") || "circle", a = t.hostModel, s = n(t, e);
            if (o !== this._symbolType) this._createSymbol(o, t, e, s); else {
                var l = this.childAt(0);
                h.updateProps(l, {scale: r(s)}, a, e)
            }
        ...
        c._updateCommon = function (t, e, i, n) {
            var o = this.childAt(0), a = t.hostModel, l = t.getItemVisual(e, "color");
            "image" !== o.type && o.useStyle({strokeNoScale: !0}), n = n || null;
            ...
            var M = o.style;
            o.attr("rotation", (v || 0) * Math.PI / 180 || 0), y && o.attr("position", [u.parsePercent(y[0], i[0]), u.parsePercent(y[1], i[1])]), o.setColor(l), o.setStyle(c);
            ...
            null != T && x.getShallow("show") ? (h.setText(M, x, l), M.text = s.retrieve(a.getFormattedLabel(e, "normal"), t.get(T, e))) : M.text = "", null != T && _.getShallow("show") ? (h.setText(m, _, l), m.text = s.retrieve(a.getFormattedLabel(e, "emphasis"), t.get(T, e))) : m.text = "", o.off("mouseover").off("mouseout").off("emphasis").off("normal"), o.hoverStyle = m, h.setHoverStyle(o);
            var C = r(i);
            if (b && a.isAnimationEnabled()) {
                ...
                o.on("mouseover", k).on("mouseout", L).on("emphasis", k).on("normal", L)
            }
        }, c.fadeOut = function (t) {
            var e = this.childAt(0);
            this.silent = !0, e.style.text = "", h.updateProps(e, {scale: [0, 0]}, this._seriesModel, this.dataIndex, t)
        }, s.inherits(o, h.Group), t.exports = o
    }, function (t, e, i) {
        function n(t) {
        ...
        var s = i(1), l = i(8), h = i(3), u = i(11), c = i(4), d = c.remRadian, f = c.isRadianAroundZero, p = i(5),
        ...
        var x = {
            axisLine: function () {
                ...
                if (t.get("axisTick.show") && !e.isBlank()) for (var i = t.getModel("axisTick"), n = this.opt, r = i.getModel("lineStyle"), o = i.get("length"), a = b(i, n.labelInterval), l = e.getTicksCoords(i.get("alignWithLabel")), u = e.scale.getTicks(), c = [], d = [], f = this._transform, p = 0; p < l.length; p++) if (!_(e, p, a)) {
                    var m = l[p];
                ...
                var e = this.opt, i = this.axisModel, o = i.axis, l = m(e.axisLabelShow, i.get("axisLabel.show"));
                if (l && !o.isBlank()) {
                    var c = i.getModel("axisLabel"), d = c.getModel("textStyle"), f = c.get("margin"),
                        p = o.scale.getTicks(), g = i.getFormattedLabels(),
                        y = m(e.labelRotation, c.get("rotate")) || 0;
                    y = y * v / 180;
                    var x = r(e, y, e.labelDirection), b = i.get("data"), w = [], M = a(i), S = i.get("triggerEvent");
                    if (s.each(p, function (t, r) {
                        if (!_(o, r, e.labelInterval)) {
                            var a = d;
                            b && b[t] && b[t].textStyle && (a = new u(b[t].textStyle, d, i.ecModel));
                            var s = a.getTextColor() || i.get("axisLine.lineStyle.color"), l = o.dataToCoord(t),
                                c = [l, e.labelOffset + e.labelDirection * f], p = o.scale.getLabel(t), m = new h.Text({
                                    anid: "label_" + t,
                                    style: {
                                        text: g[r],
                            ...
                            S && (m.eventData = n(i), m.eventData.targetType = "axisLabel", m.eventData.value = p), this._dumbGroup.add(m), m.updateTransform(), w.push(m), this.group.add(m), m.decomposeTransform()
                        }
                    }, this), null != i.getMin()) {
                        var T = w[0], A = w[1];
                        t(T, A) && (T.ignore = !0)
                ...
                if (i) {
                    var u, c = e.get("nameLocation"), d = t.nameDirection, f = e.getModel("nameTextStyle"),
                    ...
                    var w = f.getFont(), M = e.get("nameTruncate", !0) || {}, S = M.ellipsis, T = m(M.maxWidth, b),
                        A = null != S && null != T ? l.truncateText(i, T, w, S, {
                            minChar: 2,
                            placeholder: M.placeholder
                        }) : i, I = e.get("tooltip", !0), C = e.mainType,
                        k = {componentType: C, name: i, $vars: ["name"]};
                    k[C + "Index"] = e.componentIndex;
                    var L = new h.Text({
                        anid: "name",
                        __fullText: i,
                        __truncatedText: A,
                    ...
                    e.get("triggerEvent") && (L.eventData = n(e), L.eventData.targetType = "axisName", L.eventData.name = i), this._dumbGroup.add(L), L.updateTransform(), this.group.add(L), L.decomposeTransform()
                }
            }
        ...
        t.exports = {
            getFormattedLabels: function () {
                ...
                return null == i || "dataMin" === i || r.eqNaN(i) || (i = this.axis.scale.parse(i)), i
            }, getMax: function (t) {
                var e = this.option, i = t || null == e.rangeEnd ? e.max : e.rangeEnd;
                return null == i || "dataMax" === i || r.eqNaN(i) || (i = this.axis.scale.parse(i)), i
        ...
        function r(t) {
            var e, i = t.model, n = i.getFormattedLabels(), r = i.getModel("axisLabel.textStyle"), o = 1, a = n.length;
            a > 40 && (o = Math.ceil(a / 40));
            for (var s = 0; s < a; s += o) if (!t.isLabelIgnored(s)) {
        ...
        var h = i(12), u = i(22), c = i(1), d = i(121), f = i(119), p = c.each, g = u.ifAxisCrossZero,
            m = u.niceScaleExtent;
        i(122);
        var v = o.prototype;
        v.type = "grid", v.getRect = function () {
            ...
            var i, n, r = e.seriesModel, o = e.xAxisModel || r && r.getReferringComponents("xAxis")[0],
                a = e.yAxisModel || r && r.getReferringComponents("yAxis")[0], s = e.gridModel, l = this._coordsList;
            ...
            c.each(this._axesList, function (t) {
                ...
                if (l(r)) {
                    ...
                    var u = this.getCartesian(a.componentIndex, h.componentIndex), c = r.getData(), d = u.getAxis("x"),
                        f = u.getAxis("y");
        ...
        o.create = function (t, e) {
            ...
            return t.eachComponent("grid", function (n, r) {
                ...
                if (l(e)) {
                    var i = s(e, t), n = i[0], r = i[1], o = n.getCoordSysModel(), a = o.coordinateSystem;
        ...
        var n = i(86), r = i(1), o = i(13), a = i(12), s = ["value", "category", "time", "log"];
        ...
        var r = i(13), o = i(1), a = i(54), s = r.extend({
        ...
        var n = i(15), r = n.set, o = n.get;
        t.exports = {
            clearColorPalette: function () {
                r(this, "colorIdx", 0), r(this, "colorNameMap", {})
            }, getColorFromPalette: function (t, e) {
                e = e || this;
                var i = o(e, "colorIdx") || 0, n = o(e, "colorNameMap") || r(e, "colorNameMap", {});
                if (n[t]) return n[t];
        ...
        var n = i(34), r = i(44), o = i(15), a = function () {
        ...
        "use strict";
        var n = i(64), r = i(21), o = i(92), a = i(167), s = i(1), l = function (t) {
        ...
        function p(t, e, i, n, r) {
            ...
            if (x) {
                ...
                for (var A = [], I = [], C = n[0].value, k = !0, L = 0; L < x; L++) {
                    A.push(n[L].time / _);
                    var P = n[L].value;
                    if (w && h(P, C, T) || !w && P === C || (k = !1), C = P, "string" == typeof P) {
                        var D = m.parse(P);
                        D ? (P = D, M = !0) : S = !0
                    }
                    I.push(P)
                ...
                if (!k) {
                    for (var O = I[x - 1], L = 0; L < x - 1; L++) w ? l(I[L], O, T) : !isNaN(I[L]) || isNaN(O) || S || M || (I[L] = O);
                    w && l(d(t._target, r), O, T);
                    var z, E, N, R, B, V, F = 0, G = 0;
                    if (M) var H = [0, 0, 0, 0];
                    var W = function (t, e) {
                        var i;
                        ...
                        F = i, G = e;
                        var n = A[i + 1] - A[i];
                        if (0 !== n) if (E = (e - A[i]) / n, v) if (R = I[i], N = I[0 === i ? i : i - 1], B = I[i > x - 2 ? x - 1 : i + 1], V = I[i > x - 3 ? x - 1 : i + 2], w) u(N, R, B, V, E, E * E, E * E * E, d(t, r), T); else {
                            var l;
                            if (M) l = u(N, R, B, V, E, E * E, E * E * E, H, 1), l = f(H); else {
                                if (S) return a(R, B, E);
                                l = c(N, R, B, V, E, E * E, E * E * E)
                            }
                            p(t, r, l)
        ...
        var g = i(145), m = i(19), v = i(1), y = v.isArrayLike, x = Array.prototype.slice, _ = function (t, e, i, o) {
        ...
        var n = i(8), r = i(1), o = {}, a = ["x", "y", "z", "radius", "angle", "single"],
            s = ["cartesian2d", "polar", "singleAxis"];
        o.isCoordSupported = function (t) {
            return r.indexOf(s, t) >= 0
        ...
        var r = i(6), o = i(1), a = i(10), s = i(8), l = s.addCommas, h = s.encodeHTML, u = i(2).extendComponentModel({
            type: "marker", dependencies: ["series", "grid", "polar", "geo"], init: function (t, e, i, n) {
                ...
                var e = this.getData(), i = this.getRawValue(t), n = o.isArray(i) ? o.map(i, l).join(", ") : l(i),
                    r = e.getName(t), a = h(this.name);
                return (null != i || r) && (a += "<br />"), r && (a += h(r), null != i && (a += " : ")), null != i && (a += h(n)), a
            }, getData: function () {
                return this._data
            }, setData: function (t) {
                this._data = t
        ...
        var s = i(1), l = i(4), h = s.indexOf, u = s.curry,
            c = {min: u(a, "min"), max: u(a, "max"), average: u(a, "average")}, d = function (t, e) {
            ...
            e.eachRawSeriesByType(t, function (t) {
                ...
                if (!e.isSeriesFiltered(t)) {
                    ...
                    o.each(function (t) {
                        ...
                        var a = r[e], s = null != a && o.getItemVisual(a, "color", !0);
        ...
        var n = i(5), r = i(18), o = {}, a = Math.min, s = Math.max, l = Math.sin, h = Math.cos, u = n.create(),
        ...
        var n = i(36), r = i(1), o = i(17), a = function (t) {
            n.call(this, t)
        };
        a.prototype = {
        ...
        var r = i(17), o = i(9), a = new o, s = function () {
        };
        s.prototype = {
            constructor: s, drawRectText: function (t, e, i) {
                ...
                if (null != s && (s += ""), s) {
                    t.save();
                    var l, h, u = o.textPosition, c = o.textOffset, d = o.textDistance, f = o.textAlign,
                        p = o.textFont || o.font, g = o.textBaseline, m = o.textVerticalAlign;
                    i = i || r.getBoundingRect(s, p, f, g);
                    var v = this.transform;
                    if (o.textTransform ? this.setTransform(t) : v && (a.copy(e), a.applyTransform(v), e = a), u instanceof Array) {
                        if (l = e.x + n(u[0], e.width), h = e.y + n(u[1], e.height), f = f || "left", g = g || "top", m) {
                            switch (m) {
                                case"middle":
                        ...
                        var y = r.adjustTextPositionOnRect(u, e, i, d);
                        l = y.x, h = y.y, f = f || y.textAlign, g = g || y.textBaseline
                    }
                    c && (l += c[0], h += c[1]), t.textAlign = f || "left", t.textBaseline = g || "alphabetic";
                    var x = o.textFill, _ = o.textStroke;
                    x && (t.fillStyle = x), _ && (t.strokeStyle = _), t.font = p || "12px sans-serif", t.shadowBlur = o.textShadowBlur, t.shadowColor = o.textShadowColor || "transparent", t.shadowOffsetX = o.textShadowOffsetX, t.shadowOffsetY = o.textShadowOffsetY;
                    var b = s.split("\n");
                    o.textRotation && (v && t.translate(v[4], v[5]), t.rotate(o.textRotation), v && t.translate(-v[4], -v[5]));
                    for (var w = 0; w < b.length; w++) x && t.fillText(b[w], l, h), _ && t.strokeText(b[w], l, h), h += i.lineHeight;
                    t.restore()
                }
            }
        }, t.exports = s
	 ...
	 */
        var r = i(64), o = i(10), a = i(1), s = i(140), l = i(143), h = i(144), u = i(152), c = !o.canvasSupported,
            d = {canvas: i(142)}, f = {}, p = {};
        ...
        var g = function (t, e, i) {
            ...
            var n = this, r = new l, f = i.renderer;
            if (c) {
            ...
            var g = o.node ? null : new u(p.getViewportRoot());
            this.handler = new s(r, p, g, p.root), this.animation = new h({stage: {update: a.bind(this.flush, this)}}), this.animation.start(), this._needsRefresh;
            var m = r.delFromMap, v = r.addToMap;
        ...
        var r = i(1), o = i(3), a = {};
        a.setLabel = function (t, e, i, o, a, s, l) {
            var h = i.getModel("label.normal"), u = i.getModel("label.emphasis");
            h.get("show") ? n(t, h, o, r.retrieve(a.getFormattedLabel(s, "normal"), a.getRawValue(s)), l) : t.text = "", u.get("show") ? n(e, u, o, r.retrieve(a.getFormattedLabel(s, "emphasis"), a.getRawValue(s)), l) : e.text = ""
        }, t.exports = a
    }, function (t, e, i) {
        function n(t) {
            ...
            for (var _ = 0, b = i, w = 0; w < r; w++) {
                ...
                if (b === i) t[a > 0 ? "moveTo" : "lineTo"](M[0], M[1]), c(f, M); else if (v > 0) {
                    ...
                    if (!T || n(T)) c(p, M); else {
                        ...
                        if ("x" === y || "y" === y) {
                            var L = "x" === y ? 0 : 1;
                            C = Math.abs(M[L] - I[L]), k = Math.abs(M[L] - T[L])
                        } else C = s.dist(M, I), k = s.dist(M, T);
                        A = k / (k + C), u(p, M, d, -v * (1 - A))
                    }
        ...
        var a = i(7), s = i(5), l = s.min, h = s.max, u = s.scaleAndAdd, c = s.copy, d = [], f = [], p = [];
        t.exports = {
            Polyline: a.extend({
                type: "ec-polyline",
            ...
            Polygon: a.extend({
                ...
                buildPath: function (t, e) {
                    var i = e.points, a = e.stackedOnPoints, s = 0, l = i.length, h = e.smoothMonotone,
                        u = o(i, e.smoothConstraint), c = o(a, e.smoothConstraint);
                    if (e.connectNulls) {
                        for (; l > 0 && n(i[l - 1]); l--) ;
                        for (; s < l && n(i[s]); s++) ;
                    }
        ...
        var u = i(21), c = i(1), d = i(25), f = i(117);
        ...
        function o(t, e) {
            ...
            s.each(t, function (t, e) {
                var o = t.getData(), a = t.coordinateSystem, s = a.getBaseAxis(), l = s.getExtent(),
                    u = "category" === s.type ? s.getBandWidth() : Math.abs(l[1] - l[0]) / o.count(), c = i[r(s)] || {
                        bandWidth: u,
                        remainedWidth: u,
                        autoWidthCount: 0,
                        categoryGap: "20%",
                ...
                var p = h(t.get("barWidth"), u), g = h(t.get("barMaxWidth"), u), m = t.get("barGap"),
            ...
            return s.each(i, function (t, e) {
                o[e] = {};
                var i = t.stacks, n = t.bandWidth, r = h(t.categoryGap, n), a = h(t.gap, 1), l = t.remainedWidth,
                    u = t.autoWidthCount, c = (l - r) / (u + (u - 1) * a);
        ...
        function a(t, e, i) {
            ...
            e.eachSeriesByType(t, function (t) {
                var e = t.getData(), i = t.coordinateSystem, o = i.getBaseAxis(), s = n(t), u = a[r(o)][s],
                    c = u.offset, d = u.width, f = i.getOtherAxis(o), p = t.get("barMinHeight") || 0,
        ...
        "use strict";
        var n = i(1), r = i(37), o = function (t, e, i, n, o, a) {
        ...
        var r = i(20), o = i(5), a = r.identity, s = 5e-5, l = function (t) {
        ...
        function n(t, e, i, n, r, o, a) {
            var s = new h.Rect({shape: l.extend({}, n)});
            if (o) {
                var u = s.shape, c = r ? "height" : "width", d = {};
                u[c] = 0, d[c] = n[c], h[a ? "updateProps" : "initProps"](s, {shape: d}, o, e)
            }
            return s
        }

        function r(t, e, i) {
            i.style.text = "", h.updateProps(i, {shape: {width: 0}}, e, t, function () {
                i.parent && i.parent.remove(i)
            })
        }

        function o(t, e, i) {
            var n = t.getItemLayout(e), r = s(i, n), o = n.width > 0 ? 1 : -1, a = n.height > 0 ? 1 : -1;
            return {x: n.x + o * r / 2, y: n.y + a * r / 2, width: n.width - o * r, height: n.height - a * r}
        }
        ...
        function a(t, e, i, n, r, o, a) {
            ...
            var p = a ? r.height > 0 ? "bottom" : "top" : r.width > 0 ? "left" : "right";
            u.setLabel(t.style, f, n, s, o, i, p), h.setHoverStyle(t, f)
        }
        ...
        var l = i(1), h = i(3), u = i(81), c = ["itemStyle", "normal", "barBorderWidth"];
        ...
        var d = i(2).extendChartView({
            type: "bar", render: function (t, e, i) {
                ...
                var s = this.group, l = t.getData(), u = this._data, c = t.coordinateSystem, d = c.getBaseAxis(),
                    f = d.isHorizontal(), p = t.isAnimationEnabled() ? t : null;
                l.diff(u).add(function (e) {
                    if (l.hasValue(e)) {
                        var i = l.getItemModel(e), r = o(l, e, i), h = n(l, e, i, r, f, p);
                        l.setItemGraphicEl(e, h), s.add(h), a(h, l, e, i, r, t, f)
                    }
                }).update(function (e, i) {
                    var r = u.getItemGraphicEl(i);
                    if (!l.hasValue(e)) return void s.remove(r);
                    var c = l.getItemModel(e), d = o(l, e, c);
                    r ? h.updateProps(r, {shape: d}, p, e) : r = n(l, e, c, d, f, p, !0), l.setItemGraphicEl(e, r), s.add(r), a(r, l, e, c, d, t, f)
                }).remove(function (t) {
        ...
        var h = i(24), u = i(5), c = i(177), d = i(3), f = i(1), p = i(4), g = ["fromSymbol", "toSymbol"],
            m = l.prototype;
        ...
        var a = i(3), s = i(98), l = o.prototype;
        ...
        i(101), i(102), r.registerVisual(n.curry(i(45), "line", "circle", "line")), r.registerLayout(n.curry(i(56), "line")), r.registerProcessor(o.PROCESSOR.STATISTIC, n.curry(i(135), "line")), i(31)
    }, function (t, e, i) {
        "use strict";
        var n = i(35), r = i(16);
        t.exports = r.extend({
        ...
        function l(t, e, i) {
            var n = o(t.getAxis("x")), r = o(t.getAxis("y")), a = t.getBaseAxis().isHorizontal(),
                s = Math.min(n[0], n[1]), l = Math.min(r[0], r[1]), h = Math.max(n[0], n[1]) - s,
                u = Math.max(r[0], r[1]) - l, c = i.get("lineStyle.normal.width") || 2,
                d = i.get("clipOverflow") ? c / 2 : Math.max(h, u);
            a ? (l -= d, u += 2 * d) : (s -= d, h += 2 * d);
            var f = new v.Rect({shape: {x: s, y: l, width: h, height: u}});
            return e && (f.shape[a ? "width" : "height"] = 0, v.initProps(f, {shape: {width: h, height: u}}, i)), f
        }
        ...
        function d(t, e) {
            ...
            if (i && i.length && t.count()) {
                ...
                if (n && "cartesian2d" === e.type) {
                    var o = n.dimension, a = t.dimensions[o], s = e.getAxis(a), l = f.map(n.stops, function (t) {
                        return {coord: s.toGlobalCoord(s.dataToCoord(t.value)), color: t.color}
                    }), h = l.length, u = n.outerColors.slice();
                    h && l[0].coord > l[h - 1].coord && (l.reverse(), u.reverse());
                    var c = 10, d = l[0].coord - c, p = l[h - 1].coord + c, g = p - d;
        ...
        t.exports = _.extend({
            type: "line", init: function () {
                ...
                var o = t.coordinateSystem, a = this.group, l = t.getData(), h = t.getModel("lineStyle.normal"),
                    p = t.getModel("areaStyle.normal"), g = l.mapArray(l.getItemLayout, !0), m = "polar" === o.type,
                    v = this._coordSys, y = this._symbolDraw, x = this._polyline, _ = this._polygon,
                    b = this._lineGroup, w = t.get("animation"), M = !p.isEmpty(), S = s(o, l), T = t.get("showSymbol"),
                    A = T && !m && !t.get("showAllSymbol") && this._getSymbolIgnoreFunc(l, o), I = this._data;
                ...
                x.useStyle(f.defaults(h.getLineStyle(), {fill: "none", stroke: k, lineJoin: "bevel"}));
                var L = t.get("smooth");
                if (L = r(t.get("smooth")), x.setShape({
                    smooth: L,
                    smoothMonotone: t.get("smoothMonotone"),
                    connectNulls: t.get("connectNulls")
                }), _) {
                    var P = l.stackedOn, D = 0;
                    if (_.useStyle(f.defaults(p.getAreaStyle(), {fill: k, opacity: .7, lineJoin: "bevel"})), P) {
                        var O = P.hostModel;
                        D = r(O.get("smooth"))
                    }
                    _.setShape({
                ...
                var r = t.getData(), o = y.queryDataIndex(r, n);
                if (!(o instanceof Array) && null != o && o >= 0) {
                    var a = r.getItemGraphicEl(o);
                    if (!a) {
                        var s = r.getItemLayout(o);
                        if (!s) return;
                        a = new g(r, o), a.position = s, a.setZ(t.get("zlevel"), t.get("z")), a.ignore = isNaN(s[0]) || isNaN(s[1]), a.__temp = !0, r.setItemGraphicEl(o, a), a.stopSymbolAnimation(!0), this.group.add(a)
                    }
                    a.highlight()
                ...
                var o = this._polyline, a = this._polygon, s = t.hostModel,
                    l = m(this._data, t, this._stackedOnPoints, e, this._coordSys, i), h = l.current,
                    u = l.stackedOnCurrent, d = l.next, f = l.stackedOnNext;
                r && (h = c(l.current, i, r), u = c(l.stackedOnCurrent, i, r), d = c(l.next, i, r), f = c(l.stackedOnNext, i, r)), o.shape.__points = l.current, o.shape.points = h, v.updateProps(o, {shape: {points: d}}, s), a && (a.setShape({
                    points: h,
                    stackedOnPoints: u
        ...
        i(105), i(106), i(79)("pie", [{
            ...
            event: "pieunselected",
            method: "unSelect"
        }]), r.registerVisual(n.curry(i(74), "pie")), r.registerLayout(n.curry(i(108), "pie")), r.registerProcessor(n.curry(i(58), "pie"))
    }, function (t, e, i) {
        "use strict";
        var n = i(14), r = i(1), o = i(6), a = i(27), s = i(69), l = i(2).extendSeriesModel({
            type: "series.pie",
            init: function (t) {
        ...
        h.updateData = function (t, e, i) {
            ...
            var a = this.childAt(0), h = t.hostModel, u = t.getItemModel(e), c = t.getItemLayout(e),
                d = l.extend({}, c);
            if (d.label = null, i) {
                a.setShape(d);
                var f = h.getShallow("animationType");
                "scale" === f ? (a.shape.r = c.r0, s.initProps(a, {shape: {r: c.r}}, h, e)) : (a.shape.endAngle = c.startAngle, s.updateProps(a, {shape: {endAngle: c.endAngle}}, h, e))
            } else s.updateProps(a, {shape: d}, h, e);
            var p = u.getModel("itemStyle"), g = t.getItemVisual(e, "color");
            a.useStyle(l.defaults({
                lineJoin: "bevel",
                fill: g
            }, p.getModel("normal").getItemStyle())), a.hoverStyle = p.getModel("emphasis").getItemStyle(), r(this, t.getItemLayout(e), u.get("selected"), h.get("selectedOffset"), h.get("animation")), a.off("mouseover").off("mouseout").off("emphasis").off("normal"), u.get("hoverAnimation") && h.isAnimationEnabled() && a.on("mouseover", n).on("mouseout", o).on("emphasis", n).on("normal", o), this._updateLabel(t, e), s.setHoverStyle(this)
        }, h._updateLabel = function (t, e) {
            var i = this.childAt(1), n = this.childAt(2), r = t.hostModel, o = t.getItemModel(e),
                l = t.getItemLayout(e), h = l.label, u = t.getItemVisual(e, "color");
        ...
        var u = i(28).extend({
            type: "pie", init: function () {
                ...
                if (!r || r.from !== this.uid) {
                    var a = t.getData(), s = this._data, h = this.group, u = e.get("animation"), c = !s,
                        d = t.get("animationType"), f = l.curry(n, this.uid, t, u, i), p = t.get("selectedMode");
                    if (a.diff(s).add(function (t) {
                        var e = new o(a, t);
                        c && "scale" !== d && e.eachChild(function (t) {
                            t.stopAnimation(!0)
                        }), p && e.on("click", f), a.setItemGraphicEl(t, e), h.add(e)
                    }).update(function (t, e) {
                        var i = s.getItemGraphicEl(e);
                        i.updateData(a, t), i.off("click"), p && i.on("click", f), h.add(i), a.setItemGraphicEl(t, i)
                    }).remove(function (t) {
                        var e = s.getItemGraphicEl(t);
                        h.remove(e)
                    }).execute(), u && c && a.count() > 0 && "scale" !== d) {
                        var g = a.getItemLayout(0), m = Math.max(i.getWidth(), i.getHeight()) / 2,
                            v = l.bind(h.removeClipPath, h);
                        h.setClipPath(this._createClipPath(g.cx, g.cy, m, g.startAngle, g.clockwise, v, t))
                    }
                    this._data = a
                }
            }, dispose: function () {
            ...
            l.each(function (i) {
                ...
                if ("center" === m) n = f.cx, r = f.cy, d = "center"; else {
                    ...
                    if (n = S + 3 * b, r = T + 3 * w, !M) {
                        var A = S + b * (y + e - f.r), I = T + w * (y + e - f.r), C = A + (b < 0 ? -1 : 1) * x, k = I;
                        n = C + (b < 0 ? -5 : 5), r = k, c = [[S, T], [A, I], [C, k]]
                    }
                    d = M ? "center" : b > 0 ? "left" : "right"
                }
                var L = g.getModel("textStyle").getFont(), P = g.get("rotate") ? b < 0 ? -_ + Math.PI : -_ : 0,
                    D = t.getFormattedLabel(i, "normal") || l.getName(i), O = o.getBoundingRect(D, L, d, "top");
                u = !!P, f.label = {
                    x: n,
                    y: r,
                    position: m,
        ...
        var n = i(4), r = n.parsePercent, o = i(107), a = i(1), s = 2 * Math.PI, l = Math.PI / 180;
        t.exports = function (t, e, i, h) {
            e.eachSeriesByType(t, function (t) {
                var e = t.get("center"), h = t.get("radius");
                a.isArray(h) || (h = [0, h]), a.isArray(e) || (e = [e, e]);
                var u = i.getWidth(), c = i.getHeight(), d = Math.min(u, c), f = r(e[0], u), p = r(e[1], c),
                    g = r(h[0], d / 2), m = r(h[1], d / 2), v = t.getData(), y = -t.get("startAngle") * l,
                    x = t.get("minAngle") * l, _ = v.getSum("value"), b = Math.PI / (_ || v.count()) * 2,
                    w = t.get("clockwise"), M = t.get("roseType"), S = t.get("stillShowZeroSum"),
                    T = v.getDataExtent("value");
                T[0] = 0;
                var A = s, I = 0, C = y, k = w ? 1 : -1;
                if (v.each("value", function (t, e) {
                    ...
                    i = "area" !== M ? 0 === _ && S ? b : t * b : s / (v.count() || 1), i < x ? (i = x, A -= x) : I += t;
                    var r = C + k * i;
                    v.setItemLayout(e, {
                        angle: i,
                        startAngle: C,
                        ...
                        cy: p,
                        r0: g,
                        r: M ? n.linearMap(t, T, [g, m]) : m
                    }), C = r
                }, !0), A < s) if (A <= .001) {
                    var L = s / v.count();
                    v.each(function (t) {
                        var e = v.getItemLayout(t);
                        e.startAngle = y + k * t * L, e.endAngle = y + k * (t + 1) * L
                    })
                } else b = A / I, C = y, v.each("value", function (t, e) {
                    var i = v.getItemLayout(e), n = i.angle === x ? x : t * b;
                    i.startAngle = C, i.endAngle = C + k * n, C += k * n
                });
                o(t, m, u, c)
            })
        }
        ...
        function n(t, e) {
            ...
            var n = t.coordinateSystem, r = e.axis, o = {}, a = r.position, s = r.onZero ? "onZero" : a, l = r.dim,
                h = n.getRect(), u = [h.x, h.x + h.width, h.y, h.y + h.height], c = e.get("offset") || 0,
                d = {x: {top: u[2] - c, bottom: u[3] + c}, y: {left: u[0] - c, right: u[1] + c}};
        ...
        var r = i(1), o = i(3), a = i(51), s = a.ifIgnoreOnTick, l = a.getInterval,
            h = ["axisLine", "axisLabel", "axisTick", "axisName"], u = ["splitArea", "splitLine"],
            c = i(2).extendComponentView({
                type: "axis", render: function (t, e) {
                    ...
                    var n = t.axis;
                    if (!n.isBlank()) {
                        var a = t.getModel("splitLine"), h = a.getModel("lineStyle"), u = h.get("color"), c = l(a, i);
                        u = r.isArray(u) ? u : [u];
                    ...
                    var n = t.axis;
                    if (!n.isBlank()) {
                        var a = t.getModel("splitArea"), h = a.getModel("areaStyle"), u = h.get("color"),
        ...
        function n(t) {
            R.call(this), this._zr = t, this.group = new F.Group, this._brushType, this._brushOption, this._panels, this._track = [], this._dragging, this._covers = [], this._creatingCover, this._creatingPanel, this._enableGlobalPan, this._uid = "brushController_" + it++, this._handlers = {}, Z(nt, function (t, e) {
        ...
        function m(t) {
            ...
            var i = e[e.length - 1], n = e[0], r = i[0] - n[0], o = i[1] - n[1], a = X(r * r + o * o, .5);
            return a > $
        }
        ...
        function x(t, e, i, n) {
            var r = n.brushStyle.lineWidth || 0, o = U(r, Q), a = i[0][0], s = i[1][0], l = a - r / 2, h = s - r / 2,
                u = i[0][1], c = i[1][1], d = u - o + r / 2, f = c - o + r / 2, p = u - a, g = c - s, m = p + r,
                v = g + r;
        ...
        function b(t, e, i, n, r, o, a) {
            ...
            s && s.setShape(L(k(t, e, [[n, r], [n + o, r + a]])))
        }
        ...
        function M(t, e, i, n) {
            var r = [j(t, i), j(e, n)], o = [U(t, i), U(e, n)];
        ...
        function k(t, e, i) {
            ...
            return B.map(i, function (t) {
                var e = t[0];
                e = U(e, r.x), e = j(e, r.x + r.width);
                var i = t[1];
                return i = U(i, r.y), i = j(i, r.y + r.height), [e, i]
            })
        }

        function L(t) {
            var e = j(t[0][0], t[1][0]), i = j(t[0][1], t[1][1]), n = U(t[0][0], t[1][0]), r = U(t[0][1], t[1][1]);
        ...
        function z(t, e, i) {
            ...
            if (t._track.push(t.group.transformCoordToLocal(r, o)), m(t) || h) {
                ...
                if (h) {
                    ...
                    v.range = g.getCreatingRange(k(t, h, t._track)), i && (s(t, h), g.updateCommon(t, h)), l(t, h), n = {isEnd: i}
                }
        ...
        function N(t) {
            return {
                createCover: function (e, i) {
                    ...
                    var i = v(e), n = j(i[0][t], i[1][t]), r = U(i[0][t], i[1][t]);
                    return [n, r]
        ...
        var R = i(21), B = i(1), V = i(9), F = i(3), G = i(117), H = i(43), W = B.curry, Z = B.each, q = B.map,
        ...
        var nt = {
            ...
            lineX: N(0), lineY: N(1), rect: {
                ...
                createCover: function (t, e) {
                    ...
                    e.childAt(0).setShape({points: k(t, e, i)})
                }, updateCommon: _, contain: O
            }
        };
        t.exports = n
        ...
        var a = i(1), s = i(3), l = a.each, h = {}, u = ["geo", "xAxis", "yAxis"], c = "--",
        ...
        function n(t, e, i) {
            r.positionElement(t, e.getBoxLayoutParams(), {width: i.getWidth(), height: i.getHeight()}, e.get("padding"))
        }

        var r = i(12), o = i(8), a = i(3);
        t.exports = {
        ...
        var n = i(1), r = i(42), o = i(123), a = function (t, e, i, n, o) {
        ...
        var u = i(1), c = i(6), d = i(11), f = u.each, p = u.filter, g = u.map, m = u.isArray, v = u.indexOf,
            y = u.isObject, x = i(13), _ = i(127), b = "\0_ec_inner", w = d.extend({
                constructor: w, init: function (t, e, i, n) {
                    ...
                    function e(e, r) {
                        var l = c.normalizeToArray(t[e]), h = c.mappingToExists(n[e], l);
                        c.makeIdAndName(h), f(h, function (t, i) {
                            var n = t.option;
                            y(n) && (t.keyInfo.mainType = e, t.keyInfo.subType = a(e, n, t.exist))
                        });
                        var d = o(n, r);
                        i[e] = [], n[e] = [], f(h, function (t, r) {
                            var o = t.exist, a = t.option;
                            if (u.assert(y(a) || o, "Empty component definition"), a) {
                                ...
                                if (o && o instanceof s) o.name = t.keyInfo.name, o.mergeOption(a, this), o.optionUpdated(a, !1); else {
                                    var l = u.extend({dependentModels: d, componentIndex: r}, t.keyInfo);
                    ...
                    if (null != i) m(i) || (i = [i]), a = p(g(i, function (t) {
                        ...
                        var h = m(r);
                        a = p(o, function (t) {
                            return h && v(r, t.name) >= 0 || !h && t.name === r
                        })
                    } else a = o;
                    return l(a, t)
                    ...
                    h(this), f(this._seriesIndices, function (i) {
                    ...
                    h(this), f(this._seriesIndices, function (n) {
        ...
        var h = i(1), u = i(6), c = i(13), d = h.each, f = h.clone, p = h.map, g = h.merge, m = /^(min|max)?(.+)$/;
        n.prototype = {
        ...
        var r = i(1), o = i(32), a = i(4), s = i(38), l = o.prototype, h = s.prototype, u = a.getPrecisionSafe,
            c = a.round, d = Math.floor, f = Math.ceil, p = Math.pow, g = Math.log, m = o.extend({
        ...
        var n = i(1), r = i(4), o = i(8), a = i(38), s = a.prototype, l = Math.ceil, h = Math.floor, u = 1e3,
            c = 60 * u, d = 60 * c, f = 24 * d, p = function (t, e, i, n) {
                for (; i < n;) {
                    var r = i + n >>> 1;
                    t[r][2] < e ? i = r + 1 : n = r
                }
                ...
                type: "time", getLabel: function (t) {
                    ...
                    t = t || 10;
                    var e = this._extent, i = e[1] - e[0], n = i / t, o = m.length, a = p(m, n, 0, o),
                        s = m[Math.min(a, o - 1)], u = s[2];
                    if ("year" === s[0]) {
        ...
        var o = i(1), a = i(33), s = i(66), l = i(65), h = function (t, e, i) {
            var s;
        ...
        h.prototype = {
            constructor: h, elCount: 0, __dirty: !0, initContext: function () {
                ...
                var e = this.dom, i = this.ctx, n = e.width, r = e.height, o = this.clearColor,
                    a = this.motionBlur && !t, h = this.lastFrameAlpha, u = this.dpr;
        ...
        b.prototype = {
            constructor: b, isSingleCanvas: function () {
                ...
                var e = this._opts, i = ["width", "height"][t], r = ["clientWidth", "clientHeight"][t],
                ...
                var h = i(49), u = new h({id: t, style: {x: 0, y: 0, image: a}});
        ...
        var r = i(1), o = i(10), a = i(34), s = i(46), l = function () {
        ...
        "use strict";
        var n = i(1), r = i(25).Dispatcher, o = i(62), a = i(61), s = function (t) {
        ...
        var n = i(63).normalizeRadian, r = 2 * Math.PI;
        t.exports = {
            ...
            for (var u = 0, p = 0, g = 0, y = 0, x = 0, _ = 0; _ < t.length;) {
                ...
                switch (b === h.M && _ > 1 && (i || (u += m(p, g, y, x, r, l))), 1 == _ && (p = t[_], g = t[_ + 1], y = p, x = g), b) {
                    ...
                    case h.Q:
                        ...
                        break;
                    case h.A:
                        var w = t[_++], M = t[_++], S = t[_++], T = t[_++], A = t[_++], I = t[_++],
                            C = (t[_++], 1 - t[_++]), k = Math.cos(A) * S + w, L = Math.sin(A) * T + M;
                        _ > 1 ? u += m(p, g, k, L, r, l) : (y = k, x = L);
                        var P = (r - w) * T / S + w;
                        if (i) {
                            if (f.containStroke(w, M, T, A, A + I, C, e, P, l)) return !0
                        } else u += s(w, M, T, A, A + I, C, P, l);
                        p = Math.cos(A + I) * S + w, g = Math.sin(A + I) * T + M;
                        break;
                    case h.R:
                        y = p = t[_++], x = g = t[_++];
                        var D = t[_++], O = t[_++], k = y + D, L = x + O;
                        if (i) {
                            if (v(y, x, k, x, e, r, l) || v(k, x, k, L, e, r, l) || v(k, L, y, L, e, r, l) || v(y, L, y, x, e, r, l)) return !0
                        } else u += m(k, x, k, L, r, l), u += m(y, L, y, x, r, l);
                        break;
                    case h.Z:
                        if (i) {
        ...
        var h = i(29).CMD, u = i(88), c = i(148), d = i(89), f = i(147), p = i(63).normalizeRadian, g = i(18),
            m = i(90), v = u.containStroke, y = 2 * Math.PI, x = 1e-4, _ = [-1, -1, -1], b = [-1, -1];
        t.exports = {
        ...
        var h = i(25), u = i(1), c = i(21), d = i(10), f = i(150), p = h.addEventListener, g = h.removeEventListener,
            m = h.normalizeEvent, v = 300,
            y = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"],
            x = ["touchstart", "touchend", "touchmove"],
            _ = {pointerdown: 1, pointerup: 1, pointermove: 1, pointerout: 1}, b = u.map(y, function (t) {
                ...
                mousemove: function (t) {
                    ...
                    t = m(this.dom, t), t.zrByTouch = !0, this._lastTouchMoment = new Date, r(this, t, "start"), w.mousemove.call(this, t), w.mousedown.call(this, t), o(this)
                }, touchmove: function (t) {
                    t = m(this.dom, t), t.zrByTouch = !0, r(this, t, "change"), w.mousemove.call(this, t), o(this)
                }, touchend: function (t) {
                    t = m(this.dom, t), t.zrByTouch = !0, r(this, t, "end"), w.mouseup.call(this, t), +new Date - this._lastTouchMoment < v && w.click.call(this, t), o(this)
        ...
        "use strict";
        var n = i(1), r = i(37), o = function (t, e, i, n, o) {
        ...
        var r = i(18), o = i(5), a = r.quadraticSubdivide, s = r.cubicSubdivide, l = r.quadraticAt, h = r.cubicAt,
            u = r.quadraticDerivativeAt, c = r.cubicDerivativeAt, d = [];
        t.exports = i(7).extend({
            type: "bezier-curve",
            shape: {x1: 0, y1: 0, x2: 0, y2: 0, cpx1: 0, cpy1: 0, percent: 1},
            style: {stroke: "#000", fill: null},
            buildPath: function (t, e) {
                var i = e.x1, n = e.y1, r = e.x2, o = e.y2, l = e.cpx1, h = e.cpy1, u = e.cpx2, c = e.cpy2,
                    f = e.percent;
        ...
        var n = i(10), r = i(7),
            o = [["shadowBlur", 0], ["shadowColor", "#000"], ["shadowOffsetX", 0], ["shadowOffsetY", 0]];
        t.exports = r.extend({
            type: "sector",
            ...
            brush: n.browser.ie && n.browser.version >= 11 ? function () {
                ...
                if (e) for (var n = 0; n < e.length; n++) {
                    ...
                    if (a && a.startAngle === a.endAngle) {
                        for (var s = 0; s < o.length; s++) o[s][2] = i[o[s][0]], i[o[s][0]] = o[s][1];
                        t = !0;
                        break
                    }
                }
                if (r.prototype.brush.apply(this, arguments), t) for (var s = 0; s < o.length; s++) i[o[s][0]] = o[s][2]
            } : r.prototype.brush,
            buildPath: function (t, e) {
                var i = e.cx, n = e.cy, r = Math.max(e.r0 || 0, 0), o = Math.max(e.r, 0), a = e.startAngle,
                    s = e.endAngle, l = e.clockwise, h = Math.cos(a), u = Math.sin(a);
        ...
        "use strict";
        var n = i(61), r = i(1), o = r.isString, a = r.isFunction, s = r.isObject, l = i(48), h = function () {
            this.animators = []
        };
        h.prototype = {
        ...
        function n(t, e, i, n, r, o, a, s, l, h, u) {
            ...
            var b = (r === o ? -1 : 1) * c((a * a * (s * s) - a * a * (x * x) - s * s * (y * y)) / (a * a * (x * x) + s * s * (y * y))) || 0,
                w = b * a * x / s, M = b * -s * y / a, S = (t + i) / 2 + f(g) * w - d(g) * M,
                T = (e + n) / 2 + d(g) * w + f(g) * M, A = v([1, 0], [(y - w) / a, (x - M) / s]),
                I = [(y - w) / a, (x - M) / s], C = [(-1 * y - w) / a, (-1 * x - M) / s], k = v(I, C);
            m(I, C) <= -1 && (k = p), m(I, C) >= 1 && (k = 0), 0 === o && k > 0 && (k -= 2 * p), 1 === o && k < 0 && (k += 2 * p), u.addData(h, S, T, a, s, A, k, g, o)
        }
        ...
        var a = i(7), s = i(29), l = i(170), h = i(20),
            ...
            for (o = 0, u = 0; o < f.length;) {
                switch (i = f[o++], u = o, n = 0, i) {
                    ...
                    case x:
                        ...
                        break;
                    case y:
                        var _ = e[4], b = e[5], w = l(e[0] * e[0] + e[1] * e[1]), M = l(e[2] * e[2] + e[3] * e[3]),
                            S = h(-e[1] / M, e[0] / w);
        ...
        var r = i(29).CMD, o = i(5), a = o.applyTransform, s = [[], [], []], l = Math.sqrt, h = Math.atan2;
        t.exports = n
    }, function (t, e, i) {
        ...
        var r = i(3), o = i(24), a = r.extendShape({
        ...
        var n = i(1), r = i(2);
        i(179), i(180), r.registerVisual(n.curry(i(45), "scatter", "circle", null)), r.registerLayout(n.curry(i(56), "scatter")), i(31)
    }, function (t, e, i) {
        "use strict";
        var n = i(35), r = i(16);
        t.exports = r.extend({
        ...
        function o(t, e) {
            ...
            if (n) {
                var o = s.getPixelPrecision(r, [0, 500]), a = e || 0 === n[0] && 100 === n[1];
                i.setRange(a ? null : +r[0].toFixed(o), a ? null : +r[1].toFixed(o))
            }
        }

        var a = i(1), s = i(4), l = i(68), h = a.each, u = s.asc, c = function (t, e, i, n) {
        ...
        c.prototype = {
            constructor: c, hostedBy: function (t) {
                ...
                var e = this._dataExtent, i = this.getAxisModel(), n = i.axis.scale, o = [0, 100], a = [t.start, t.end],
                    l = [];
                return e = e.slice(), r(e, i), h(["startValue", "endValue"], function (e) {
                    l.push(null != t[e] ? n.parse(t[e]) : null)
                }), h([0, 1], function (t) {
                    var i = l[t], r = a[t];
                    null != r || null == i ? (null == r && (r = o[t]), i = n.parse(s.linearMap(r, o, e, !0))) : r = s.linearMap(i, e, o, !0), l[t] = i, a[t] = r
                }), {valueWindow: u(l), percentWindow: u(a)}
            }, reset: function (t) {
                if (t === this._dataZoomModel) {
                    this._dataExtent = n(this._dimName, this.getTargetSeriesModels());
                    var e = this.calculateDataWindow(t.option);
                    this._valueWindow = e.valueWindow, this._percentWindow = e.percentWindow, o(this)
                }
            }, restore: function (t) {
        ...
        function n(t) {
            var e = [0, 100];
            return !(t[0] <= e[1]) && (t[0] = e[1]), !(t[1] <= e[1]) && (t[1] = e[1]), !(t[0] >= e[0]) && (t[0] = e[0]), !(t[1] >= e[0]) && (t[1] = e[0]),
                t
        }

        var r = i(41), o = i(1), a = i(85), s = i(189), l = o.bind, h = r.extend({
            type: "dataZoom.inside", init: function (t, e) {
                this._range
            }, render: function (t, e, i, n) {
                h.superApply(this, "render", arguments), s.shouldRecordRange(n, t.id) && (this._range = t.getPercentRange()), o.each(this.getTargetCoordInfo(), function (e, n) {
                    var r = o.map(e, function (t) {
                    ...
                    o.each(e, function (e) {
                        ...
                        s.register(i, {
                            ...
                            containsPoint: function (t, e) {
                                return o.coordinateSystem.containPoint([t, e])
                            },
                            dataZoomId: t.id,
                ...
                if (d) {
                    var f = u[e]([o, s], [l, h], d, i, t), p = f.signal * (c[1] - c[0]) * f.pixel / f.pixelLength;
            ...
            grid: function (t, e, i, n, r) {
                ...
                var o = i.axis, a = r.model.coordinateSystem.getRect(), s = {};
        ...
        var r = i(1), o = i(3), a = i(47), s = i(41), l = o.Rect, h = i(4), u = h.linearMap, c = i(12), d = i(85),
            f = h.asc, p = r.bind, g = r.each, m = 7, v = 1, y = 30, x = "horizontal", _ = "vertical", b = 5,
            w = ["line", "bar", "candlestick", "scatter"], M = s.extend({
                type: "dataZoom.slider", init: function (t, e) {
                    ...
                    if (t) {
                        ...
                        if (null != a) {
                            ...
                            s = [s[0] - l, s[1] + l];
                            var h, c = [0, e[1]], d = [0, e[0]], f = [[e[0], 0], [0, 0]], p = [],
                        ...
                        return t.eachTargetAxis(function (a, s) {
                            ...
                            r.each(l, function (t) {
                                if (!(i || e !== !0 && r.indexOf(w, t.get("type")) < 0)) {
                                    var l, h = o.getComponent(a.axis, s).axis, u = n(a.name), c = t.coordinateSystem;
                                    null != u && c.getOtherAxis && (l = c.getOtherAxis(h).inverse), i = {
                                        thisAxis: h,
                                        series: t,
                                        thisDim: a.name,
                                        otherDim: u,
                    ...
                    var e = this._displayables, i = this._handleEnds, n = f(i.slice()), r = this._size;
                    g([0, 1], function (t) {
                        var n = e.handles[t], o = this._handleHeight;
                        n.attr({scale: [o, o], position: [i[t], r[1] / 2 - o / 2]})
                    ...
                    function e(t) {
                        var e = o.getTransform(n.handles[t].parent, this.group),
                            i = o.transformDirection(0 === t ? "right" : "left", e), l = this._handleWidth / 2 + b,
                            h = o.applyTransform([d[t] + (0 === t ? -l : l), this._size[1] / 2], e);
                        r[t].setStyle({
                            x: h[0],
                            y: h[1],
                    ...
                    var i = this.dataZoomModel, n = this._displayables, r = n.handleLabels, a = this._orient, s = ["", ""];
                    if (i.get("showDetail")) {
                        var l = i.findRepresentativeAxisProxy();
                        if (l) {
                            var h = l.getAxisModel().axis, u = this._range, c = t ? l.calculateDataWindow({
                                start: u[0],
                                end: u[1]
                            }).valueWindow : l.getDataValueWindow();
                            s = [this._formatLabel(c[0], h), this._formatLabel(c[1], h)]
                        }
                    }
        ...
        var u = i(1), c = i(84), d = i(47), f = u.curry, p = "\0_ec_dataZoom_roams", g = {
            register: function (t, e) {
        ...
        function n(t, e, i, n) {
            var r = i.type, o = u[r.charAt(0).toUpperCase() + r.slice(1)], a = new o(i);
        ...
        var s = i(2), l = i(1), h = i(6), u = i(3), c = i(12);
        ...
        var d = s.extendComponentModel({
            ...
            optionUpdated: function (t, e) {
                var i = this.option, n = (e ? i : t).elements, r = i.elements = e ? [] : i.elements, o = [];
                this._flatten(n, o);
                var s = h.mappingToExists(r, o);
                h.makeIdAndName(s);
                ...
                l.each(s, function (t, e) {
                    ...
                    if (n) {
                        n.id = t.keyInfo.id;
                        var o = n.parentId, s = n.parentOption, h = i && i.parentId;
                        !n.type && i && (n.type = i.type), n.parentId = o ? o : s ? s.id : h ? h : null, n.parentOption = null, u.push(n);
                        var d = l.extend({}, n), f = n.$action;
                        if (f && "merge" !== f) "replace" === f ? r[e] = d : "remove" === f && i && (r[e] = null); else if (i) {
                            l.merge(i, d, !0), c.mergeLayoutParam(i, d, {ignoreSize: !0}), c.copyLayoutParams(n, i)
                        } else r[e] = d;
                        r[e] && (r[e].hv = n.hv = [a(n, ["left", "right"]), a(n, ["top", "bottom"])], "group" === r[e].type && (null == r[e].width && (r[e].width = n.width = 0), null == r[e].height && (r[e].height = n.height = 0)))
                    }
                }, this);
        ...
        s.extendComponentView({
            type: "graphic", init: function (t, e) {
                ...
                if (i) {
                    ...
                    l.each(i, function (t) {
                        var e = t.$action, i = t.id, h = a[i], u = t.parentId, c = null != u ? a[u] : s;
                        t.hv && t.hv[1] && "text" === t.type && (t.style = l.defaults({textBaseline: "middle"}, t.style), t.style.textVerticalAlign = null);
                        var d = o(t);
                        e && "merge" !== e ? "replace" === e ? (r(h, a), n(i, c, d, a)) : "remove" === e && r(h, a) : h ? h.attr(d) : n(i, c, d, a), a[i] && (a[i].__ecGraphicWidth = t.width, a[i].__ecGraphicHeight = t.height)
                    })
                }
            }, _relocate: function (t, e) {
                for (var i = t.option.elements, n = this.group, r = this._elMap, o = i.length - 1; o >= 0; o--) {
                    var a = i[o], s = r[a.id];
                    if (s) {
                        var l = s.parent, h = l === n ? {
                            width: e.getWidth(),
                            height: e.getHeight()
                        } : {width: l.__ecGraphicWidth || 0, height: l.__ecGraphicHeight || 0};
                        c.positionElement(s, a, h, null, {hv: a.hv, boundingMode: a.bounding})
                    }
                }
            }, _clear: function () {
                var t = this._elMap;
        ...
        "use strict";
        var n = i(1), r = i(11), o = i(2).extendComponentModel({
            type: "legend",
            dependencies: ["series"],
        ...
        var a = i(1), s = i(24), l = i(3), h = i(118), u = a.curry;
        t.exports = i(2).extendComponentView({
                    ...
                    a.each(t.getData(), function (a) {
                        ...
                        if (!f[h]) if (p) {
                            ...
                            var v = g.getVisual("legendSymbol") || "roundRect", y = g.getVisual("symbol"),
                                x = this._createItem(h, a, t, v, y, d, m, c);
                            ...
                            if (!f[h] && e.legendDataProvider) {
                                ...
                                var p = s.getItemVisual(l, "color"), g = "roundRect",
                                    m = this._createItem(h, a, t, g, null, d, p, c);
        ...
        function a(t, e, i, r, o) {
            var a, s = r.coordinateSystem, l = t.getItemModel(e), h = u.parsePercent(l.get(i[0]), o.getWidth()),
                c = u.parsePercent(l.get(i[1]), o.getHeight());
            if (isNaN(h) || isNaN(c)) {
        ...
        var l = i(1), h = i(14), u = i(4), c = i(3), d = i(19), f = i(72), p = function (t, e, i, n) {
        ...
        i(71).extend({
            type: "markArea", updateLayout: function (t, e, i) {
                ...
                e.setData(p), p.each(function (e) {
                    ...
                    r.getShallow("show") ? (c.setText(t.style, r, h), t.style.text = l.retrieve(e.getFormattedLabel(i, "normal"), s)) : t.style.text = "", o.getShallow("show") ? (c.setText(t.hoverStyle, o, h), t.hoverStyle.text = l.retrieve(e.getFormattedLabel(i, "emphasis"), s)) : t.hoverStyle.text = "", c.setHoverStyle(t, {}), t.dataModel = e
        ...
        function a(t, e, i, r, o) {
            var a, s = r.coordinateSystem, l = t.getItemModel(e), h = u.parsePercent(l.get("x"), o.getWidth()),
                c = u.parsePercent(l.get("y"), o.getHeight());
            if (isNaN(h) || isNaN(c)) {
        ...
        var l = i(1), h = i(14), u = i(4), c = i(72), d = i(99), f = function (t, e, i, n) {
        ...
        function n(t, e, i) {
            ...
            t.each(function (r) {
                var o, a = t.getItemModel(r), l = s.parsePercent(a.get("x"), i.getWidth()),
                    h = s.parsePercent(a.get("y"), i.getHeight());
                if (isNaN(l) || isNaN(h)) {
        ...
        var o = i(39), a = i(1), s = i(4), l = i(14), h = i(72);
        i(71).extend({
            ...
            type: "title", render: function (t, e, i) {
                if (this.group.removeAll(), t.get("show")) {
                    var n = this.group, a = t.getModel("textStyle"), s = t.getModel("subtextStyle"),
                        l = t.get("textAlign"), h = t.get("textBaseline"), u = new r.Text({
                            style: {text: t.get("text"), textFont: a.getFont(), fill: a.getTextColor()}, z2: 10
        ...
        var n = i(26), r = i(1), o = i(2).extendComponentModel({
            type: "toolbox",
            layoutMode: {type: "box", ignoreSize: !0},
        ...
        (function (e) {
            ...
            var r = i(26), o = i(1), a = i(3), s = i(11), l = i(43), h = i(118), u = i(17);
            t.exports = i(2).extendComponentView({
                type: "toolbox", render: function (t, e, i, c) {
                    ...
                    function f(n, r, s) {
                        var l = n.getModel("iconStyle"), h = r.getIcons ? r.getIcons() : n.get("icon"),
                            u = n.get("title") || {};
                        if ("string" == typeof h) {
                            var c = h, d = u;
                            h = {}, u = {}, h[s] = c, u[s] = d
                    ...
                    if (p.removeAll(), t.get("show")) {
                        ...
                        o.each(m, function (t, e) {
                            ...
                            if (n && e) {
                                var r = u.getBoundingRect(e, n.font), o = t.position[0] + p.position[0],
        ...
        d.defaultOption = {
            ...
            var b = "float:right;margin-right:20px;border:none;cursor:pointer;padding:2px 5px;font-size:12px;border-radius:3px",
                w = document.createElement("div"), M = document.createElement("div");
        ...
        function a(t, e, i, n) {
            ...
            var a = h.makeCoordInfoList(r(t.option), e),
        ...
        var s = i(1), l = i(115), h = i(116), u = i(113), c = s.each;
        i(190);
        ...
        o.onclick = function (t, e) {
            var i = this.model, n = i.get("name") || t.get("title.0.text") || "echarts",
                o = document.createElement("a"), a = i.get("type", !0) || "png";
            ...
            if (o.href = s, "function" != typeof MouseEvent || r.browser.ie || r.browser.edge) {
                var l = i.get("lang"),
                    h = '<body style="margin:0;"><img src="' + s + '" style="max-width:100%;" title="' + (l && l[0] || "") + '" /></body>',
                    u = window.open();
                u.document.write(h)
            } else {
        ...
        function o(t) {
            ...
            var e = [], i = t.get("transitionDuration"), o = t.get("backgroundColor"), a = t.getModel("textStyle"),
                s = t.get("padding");
            return i && e.push(n(i)), o && (f.canvasSupported ? e.push("background-Color:" + o) : (e.push("background-Color:#" + l.toHex(o)), e.push("filter:alpha(opacity=70)"))), c(["width", "color", "radius"], function (i) {
                var n = "border-" + i, r = d(n), o = t.get(r);
                null != o && e.push(n + ":" + o + ("color" === i ? "" : "px"))
            }), e.push(r(a)), null != s && e.push("padding:" + u.normalizeCssArray(s).join("px ") + "px"), e.join(";") + ";"
        }
        ...
        function a(t, e) {
            ...
            i.onmouseenter = function () {
                ...
                if (e = e || window.event, !r.enterable) {
                    var i = n.handler;
                    h.normalizeEvent(t, e, !0), i.dispatch("mousemove", e)
                }
        ...
        var s = i(1), l = i(19), h = i(25), u = i(8), c = s.each, d = u.toCamelCase, f = i(10),
            p = ["", "-webkit-", "-moz-", "-o-"],
        ...
        a.prototype = {
            constructor: a, enterable: !0, update: function () {
                ...
                var e = this.el;
                e.style.cssText = g + o(t) + ";left:" + this._x + "px;top:" + this._y + "px;" + (t.get("extraCssText") || ""), e.style.display = e.innerHTML ? "block" : "none", this._show = !0
        ...
        function l(t, e, i, n, r) {
            var o = i.clientWidth, a = i.clientHeight;
            return t = Math.min(t + o, n) - o, e = Math.min(e + a, r) - a, t = Math.max(t, 0), e = Math.max(e, 0), [t, e]
        }
        ...
        function u(t, e, i, n, r, o, a, u) {
            var c = u.getWidth(), d = u.getHeight(), f = a && a.getBoundingRect().clone();
            if (a && f.applyTransform(a.transform), "function" == typeof t && (t = t([e, i], o, r.el, f)), p.isArray(t)) e = y(t[0], c), i = y(t[1], d); else if ("string" == typeof t && a) {
                var g = h(t, f, r.el);
                e = g[0], i = g[1]
            } else {
                var g = s(e, i, r.el, c, d);
                e = g[0], i = g[1]
            }
            if (n) {
                var g = l(e, i, r.el, c, d);
                e = g[0], i = g[1]
            }
            r.moveTo(e, i)
        }
        ...
        i(2).extendComponentView({
            type: "tooltip", _axisPointers: {}, init: function (t, e) {
                ...
                if (n.from !== this.uid) {
                    var e = this._ecModel, o = n.seriesIndex, a = e.getSeriesByIndex(o), i = this._api,
                        s = "axis" === this._tooltipModel.get("trigger");
                    if (null == n.x || null == n.y) {
                        if (s ? (a && !r(a) && (a = null), a || e.eachSeries(function (t) {
                            c(t) && !a && r(t) && (a = t)
                        })) : a = a || e.getSeriesByIndex(0), a) {
                            var l = a.getData(), h = v.queryDataIndex(l, n);
                            if (null == h || p.isArray(h)) return;
                            var u, d, f = l.getItemGraphicEl(h), g = a.coordinateSystem;
                            if (a.getTooltipPosition) {
                                var m = a.getTooltipPosition(h) || [];
                                u = m[0], d = m[1]
                                ...
                                y.applyTransform(f.transform), u = y.x + y.width / 2, d = y.y + y.height / 2
                            }
                            null != u && null != d && this._tryShow({
                                offsetX: u,
                                offsetY: d,
                                position: n.position,
                                target: f,
                ...
                if (i) if (this._lastX = t.offsetX, this._lastY = t.offsetY, e && null != e.dataIndex) {
                    var a = e.dataModel || r.getSeriesByIndex(e.seriesIndex), s = e.dataIndex, l = a.getData(),
                        h = l.getItemModel(s);
                    "axis" === (h.get("tooltip.trigger") || n) ? this._showAxisTooltip(i, r, t) : (this._ticket = "", this._hideAxisPointer(), this._resetLastHover(), this._showItemTooltipContent(a, s, e.dataType, t)), o.dispatchAction({
                        type: "showTip",
                        from: this.uid,
                        dataIndexInside: s,
                    ...
                    var d = new _(u, i), f = d.get("content"), p = Math.random();
                    this._showTooltipContent(d, f, d.get("formatterParams") || {}, p, t.offsetX, t.offsetY, t.position, e, o)
                ...
                p.each(this._seriesGroupByAxis, function (e) {
                    ...
                    h = !1;
                    var u = s.dimensions, c = s.pointToData(l, !0);
                    l = s.dataToPoint(c);
                    var d = s.getBaseAxis(), f = r.get("axis");
                    if ("auto" === f && (f = d.dim), d.isBlank() || p.eqNaN(l[0]) || p.eqNaN(l[1])) return void this._hideAxisPointer(s.name);
                    var g = !1, m = this._lastHover;
                    if ("cross" === o) n(m.data, c) && (g = !0), m.data = c; else {
                        var v = p.indexOf(u, f);
                        m.data === c[v] && (g = !0), m.data = c[v]
                    }
                    var y = t.get("animation");
                    "cartesian2d" !== s.type || g ? "polar" !== s.type || g ? "singleAxis" !== s.type || g || this._showSinglePointer(r, s, f, l, y) : this._showPolarPointer(r, s, f, l, y) : this._showCartesianPointer(r, s, f, l, y), "cross" !== o && this._dispatchAndShowSeriesTooltipContent(s, e.series, l, c, g, i.position)
                ...
                function s(i, n, o) {
                    var a = "x" === i ? r(n[0], o[0], n[0], o[1]) : r(o[0], n[1], o[1], n[1]),
                        s = h._getPointerElement(e, t, i, a);
                ...
                function l(i, n, r) {
                    var a = e.getAxis(i), s = a.getBandWidth(), l = r[1] - r[0],
                        u = "x" === i ? o(n[0] - s / 2, r[0], s, l) : o(r[0], n[1] - s / 2, l, s),
                        c = h._getPointerElement(e, t, i, u);
                    d ? f.updateProps(c, {shape: u}, t) : c.attr({shape: u})
                }

                var h = this, u = t.get("type"), c = e.getBaseAxis(),
                    d = a && "cross" !== u && "category" === c.type && c.getBandWidth() > 20;
                if ("cross" === u) s("x", n, e.getAxis("y").getGlobalExtent()), s("y", n, e.getAxis("x").getGlobalExtent()), this._updateCrossText(e, n, t); else {
                    var p = e.getAxis("x" === i ? "y" : "x"), g = p.getGlobalExtent();
                    "cartesian2d" === e.type && ("line" === u ? s : l)(i, n, g)
                }
            }, _showSinglePointer: function (t, e, i, n, o) {
                function a(i, n, o) {
                    var a = e.getAxis(), l = a.orient,
                        u = "horizontal" === l ? r(n[0], o[0], n[0], o[1]) : r(o[0], n[1], o[1], n[1]),
                        c = s._getPointerElement(e, t, i, u);
                    h ? f.updateProps(c, {shape: u}, t) : c.attr({shape: u})
                }

                var s = this, l = t.get("type"), h = o && "cross" !== l && "category" === e.getBaseAxis().type,
                    u = e.getRect(), c = [u.y, u.y + u.height];
                a(i, n, c)
            }, _showPolarPointer: function (t, e, i, n, o) {
                function s(i, n, o) {
                    var a, s = e.pointToCoord(n);
                    if ("angle" === i) {
                        var l = e.coordToPoint([o[0], s[1]]), u = e.coordToPoint([o[1], s[1]]);
                        a = r(l[0], l[1], u[0], u[1])
                    } else a = {cx: e.cx, cy: e.cy, r: s[0]};
                    var c = h._getPointerElement(e, t, i, a);
                    p ? f.updateProps(c, {shape: a}, t) : c.attr({shape: a})
                }

                function l(i, n, r) {
                    var o, s = e.getAxis(i), l = s.getBandWidth(), u = e.pointToCoord(n), c = Math.PI / 180;
                    o = "angle" === i ? a(e.cx, e.cy, r[0], r[1], (-u[1] - l / 2) * c, (-u[1] + l / 2) * c) : a(e.cx, e.cy, u[0] - l / 2, u[0] + l / 2, 0, 2 * Math.PI);
                    var d = h._getPointerElement(e, t, i, o);
                    p ? f.updateProps(d, {shape: o}, t) : d.attr({shape: o})
                }

                var h = this, u = t.get("type"), c = e.getAngleAxis(), d = e.getRadiusAxis(),
                    p = o && "cross" !== u && "category" === e.getBaseAxis().type;
                if ("cross" === u) s("angle", n, d.getExtent()), s("radius", n, c.getExtent()), this._updateCrossText(e, n, t); else {
                ...
                var h = e.get("type"), u = e.getModel(h + "Style"), c = "shadow" === h,
                    d = u[c ? "getAreaStyle" : "getLineStyle"](),
                    p = "polar" === t.type ? c ? "Sector" : "radius" === i ? "Circle" : "Line" : c ? "Rect" : "Line";
                c ? d.stroke = null : d.fill = null;
                var g = s[l][i] = new f[p]({style: d, z: o, zlevel: a, silent: !0, shape: n});
                ...
                if (e.length) {
                    ...
                    p.each(c, function (t, i) {
                        e[i].getData().hasValue(t.dataIndexInside) && (h = i)
                    }), h = h || 0;
                    var d = this._lastHover, f = this._api;
                    d.payloadBatch && !r && f.dispatchAction({
                        type: "downplay",
                        batch: d.payloadBatch
                    }), r || (f.dispatchAction({type: "highlight", batch: c}), d.payloadBatch = c);
                    var m = c[h].dataIndexInside;
                    if (f.dispatchAction({
                        type: "showTip",
                        dataIndexInside: m,
                        dataIndex: e[h].getData().getRawIndex(m),
                        seriesIndex: c[h].seriesIndex,
                        from: this.uid
                    }), s && a.get("showContent") && a.get("show")) {
                        var v = p.map(e, function (t, e) {
                            return t.getDataParams(c[e].dataIndexInside)
                        });
                        if (r) u(o || a.get("position"), i[0], i[1], a.get("confine"), this._tooltipContent, v, null, f); else {
                            var y = c[h].dataIndexInside,
                                x = "time" === s.type ? s.scale.getLabel(n[l]) : e[h].getData().getName(y),
                                _ = (x ? g.encodeHTML(x) + "<br />" : "") + p.map(e, function (t, e) {
                                    return t.formatTooltip(c[e].dataIndexInside, !0)
                                }).join("<br />"), b = "axis_" + t.name + "_" + y;
                            this._showTooltipContent(a, _, v, b, i[0], i[1], o, null, f)
                        }
                    }
                }
                ...
                var h = this._tooltipModel, u = t.getModel("tooltip", h), c = new _(s, u, u.ecModel),
                ...
                if (this._ticket = "", t.get("showContent") && t.get("show")) {
                    var h = this._tooltipContent, c = t.get("confine"), d = t.get("formatter");
                    a = a || t.get("position");
                    var f = e;
                    if (d) if ("string" == typeof d) f = g.formatTpl(d, i, !0); else if ("function" == typeof d) {
                        var p = this, m = n, v = function (t, e) {
                            t === p._ticket && (h.setContent(e), u(a, r, o, c, h, i, s, l))
                        };
                        p._ticket = m, f = d(i, m, v)
                    }
                    h.show(t), h.setContent(f), u(a, r, o, c, h, i, s, l)
                }
        ...
        if (!i(10).canvasSupported) {
            var n = i(5), r = i(9), o = i(29).CMD, a = i(19), s = i(17), l = i(77), h = i(36), u = i(49), c = i(76),
                d = i(7), f = i(37), p = i(171), g = Math.round, m = Math.sqrt, v = Math.abs, y = Math.cos,
                x = Math.sin, _ = Math.max, b = n.applyTransform, w = ",", M = "progid:DXImageTransform.Microsoft",
                S = 21600, T = S / 2, A = 1e5, I = 1e3, C = function (t) {
                    ...
                    var n = a.parse(e);
                    i = +i, isNaN(i) && (i = 1), n && (t.color = L(n[0], n[1], n[2]), t.opacity = i * n[3])
                }, N = function (t) {
                    var e = a.parse(t);
                    ...
                    if (null != n) if (n instanceof f) {
                        ...
                        for (var A = T.length, I = [], C = [], k = 0; k < A; k++) {
                            var L = T[k], P = N(L.color);
                            C.push(L.offset * l + s + " " + P[0]), 0 !== k && k !== A - 1 || I.push(P)
                        }
                        if (A >= 2) {
                            var D = I[0][0], O = I[1][0], z = I[0][1] * e.opacity, R = I[1][1] * e.opacity;
                            t.type = r, t.method = "none", t.focus = "100%", t.angle = o, t.color = D, t.color2 = O, t.colors = C.join(","), t.opacity = R, t.opacity2 = z
                        }
                    ...
                    null != i[e] && "none" !== i[e] && (r || !r && i.lineWidth) ? (t[r ? "filled" : "stroked"] = "true", i[e] instanceof f && D(t, o), o || (o = p.createNode(e)), r ? R(o, i, n) : B(o, i), P(t, o)) : (t[r ? "filled" : "stroked"] = "false", D(t, o))
                }, F = [[], [], []], G = function (t, e) {
                    ...
                    for (a = 0; a < t.length;) {
                        switch (r = t[a++], n = "", i = 0, r) {
                            ...
                            case u:
                                ...
                                break;
                            case d:
                                var k = 0, L = 0, P = 1, D = 1, O = 0;
                                e && (k = e[4], L = e[5], P = m(e[0] * e[0] + e[1] * e[1]), D = m(e[2] * e[2] + e[3] * e[3]), O = Math.atan2(-e[1] / D, e[0] / P));
                                var z = t[a++], E = t[a++], N = t[a++], R = t[a++], B = t[a++] + O, V = t[a++] + B + O;
                                a++;
                                var G = t[a++], H = z + y(B) * N, W = E + x(B) * R, M = z + y(V) * N, A = E + x(V) * R,
                                    Z = G ? " wa " : " at ";
                                Math.abs(H - M) < 1e-4 && (Math.abs(V - B) > .01 ? G && (H += 270 / S) : Math.abs(W - E) < 1e-4 ? G && H < z || !G && H > z ? A -= 270 / S : A += 270 / S : G && W < E || !G && W > E ? M += 270 / S : M -= 270 / S), p.push(Z, g(((z - N) * P + k) * S - T), w, g(((E - R) * D + L) * S - T), w, g(((z + N) * P + k) * S - T), w, g(((E + R) * D + L) * S - T), w, g((H * P + k) * S - T), w, g((W * D + L) * S - T), w, g((M * P + k) * S - T), w, g((A * D + L) * S - T)), s = M, l = A;
                                break;
                            case o.R:
                                var q = F[0], j = F[1];
                        ...
                        if (i > 0) {
                            ...
                            for (var U = 0; U < i; U++) {
                                var X = F[U];
                                e && b(X, X, e), p.push(g(X[0] * S - T), w, g(X[1] * S - T), U < i - 1 ? w : "")
                            }
                        }
                    }
                    return p.join("")
            ...
            d.prototype.brushVML = function (t) {
                ...
                var l = this.path;
                this.__dirtyPath && (l.beginPath(), this.buildPath(l, this.shape), l.toStatic(), this.__dirtyPath = !1), i.path = G(l.data, this.transform), i.style.zIndex = O(this.zlevel, this.z, this.z2), P(t, i), null != e.text ? this.drawRectText(t, this.getBoundingRect()) : this.removeRectText(t)
            ...
            u.prototype.brushVML = function (t) {
                ...
                if (r) {
                    var h = n.x || 0, u = n.y || 0, c = n.width, d = n.height, f = n.sWidth, v = n.sHeight,
                        y = n.sx || 0, x = n.sy || 0, S = f && v, T = this._vmlEl;
                    T || (T = p.doc.createElement("div"), C(T), this._vmlEl = T);
                    var A, I = T.style, k = !1, L = 1, D = 1;
                    if (this.transform && (A = this.transform, L = m(A[0] * A[0] + A[1] * A[1]), D = m(A[2] * A[2] + A[3] * A[3]), k = A[1] || A[2]), k) {
                        var z = [h, u], E = [h + c, u], N = [h, u + d], R = [h + c, u + d];
                        b(z, z, A), b(E, E, A), b(N, N, A), b(R, R, A);
                        var B = _(z[0], E[0], N[0], R[0]), V = _(z[1], E[1], N[1], R[1]), F = [];
                        F.push("M11=", A[0] / L, w, "M12=", A[2] / D, w, "M21=", A[1] / L, w, "M22=", A[3] / D, w, "Dx=", g(h * L + A[4]), w, "Dy=", g(u * D + A[5])), I.padding = "0 " + g(B) + "px " + g(V) + "px 0", I.filter = M + ".Matrix(" + F.join("") + ", SizingMethod=clip)"
                    } else A && (h = h * L + A[4], u = u * D + A[5]), I.filter = "", I.left = g(h) + "px", I.top = g(u) + "px";
                    var G = this._imageEl, W = this._cropEl;
                    G || (G = p.doc.createElement("div"), this._imageEl = G);
                    var Z = G.style;
                    if (S) {
                        if (e && i) Z.width = g(L * e * c / f) + "px", Z.height = g(D * i * d / v) + "px"; else {
                            var q = new Image, j = this;
                            q.onload = function () {
                                q.onload = null, e = q.width, i = q.height, Z.width = g(L * e * c / f) + "px", Z.height = g(D * i * d / v) + "px", j._imageWidth = e, j._imageHeight = i, j._imageSrc = r
                            }, q.src = r
                        }
                        W || (W = p.doc.createElement("div"), W.style.overflow = "hidden", this._cropEl = W);
                        var U = W.style;
                        U.width = g((c + y * c / f) * L), U.height = g((d + x * d / v) * D), U.filter = M + ".Matrix(Dx=" + -y * c / f * L + ",Dy=" + -x * d / v * D + ")", W.parentNode || T.appendChild(W), G.parentNode != W && W.appendChild(G)
                    } else Z.width = g(L * c) + "px", Z.height = g(D * d) + "px", T.appendChild(G), W && W.parentNode && (T.removeChild(W), this._cropEl = null);
                    var X = "", Y = n.opacity;
                    Y < 1 && (X += ".Alpha(opacity=" + g(100 * Y) + ") "), X += M + ".AlphaImageLoader(src=" + r + ", SizingMethod=scale)", Z.filter = X, T.style.zIndex = O(this.zlevel, this.z, this.z2), P(t, T), null != n.text && this.drawRectText(t, this.getBoundingRect())
                }
            ...
            for (var $ = new r, Q = function (t, e, i, n) {
                ...
                if (null != o && (o += ""), o) {
                    var a, l, h = r.textAlign, u = Y(r.textFont),
                    ...
                    I ? (T = I.firstChild, M = T.nextSibling, S = M.nextSibling) : (I = A("line"), M = A("path"), S = A("textpath"), T = A("skew"), S.style["v-text-align"] = "left", C(I), M.textpathok = !0, S.on = !0, I.from = "0 0", I.to = "1000 0.05", P(I, T), P(I, M), P(I, S), this._textVmlEl = I);
                    var L = [a, l], D = I.style;
                    m && n ? (b(L, L, m), T.on = !0, T.matrix = m[0].toFixed(3) + w + m[2].toFixed(3) + w + m[1].toFixed(3) + w + m[3].toFixed(3) + ",0,0", T.offset = (g(L[0]) || 0) + "," + (g(L[1]) || 0), T.origin = "0 0", D.left = "0px", D.top = "0px") : (T.on = !1, D.left = g(a) + "px", D.top = g(l) + "px"), S.string = k(o);
                    try {
                        S.style.font = c
                    } catch (E) {
                    }
                    V(I, "fill", {
                        ...
                        opacity: r.opacity,
                        lineDash: r.lineDash
                    }, this), I.style.zIndex = O(this.zlevel, this.z, this.z2), P(t, I)
                }
            }, K = function (t) {
